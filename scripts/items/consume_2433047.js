...
var itemList = Array(
        Array(2028300, 1200, 1),
        Array(2028301, 1200, 1),
        Array(2028302, 1200, 1),
        Array(2028303, 1200, 1),
        Array(2028304, 1200, 1),
        Array(2028305, 1200, 1),
        Array(2434321, 1200, 1),
        Array(2434322, 1200, 1),
        Array(2435800, 1200, 1)
...
var tt = "#fEffect/ItemEff/1112811/0/0#"; //音符
    ...
    if (player.getFreeSlots(1) < 1) {
        ...
        if (finalitem.length != 0) {
            ...
            player.loseItem(2433047, 1);
           //npc.broadcastGachaponMsgEx("[拼圖抽取] : 玩家 " + player.getName() + "," + newItem + "", newItem);
        } else {
