...
text += "#v2644008##z2644008##r*1#b個  \r\n";//追加
text += "#v2049389##z2049389##r*1#b個  \r\n";//20*
text += "#v5064400##z5064400##r*20#b個  \r\n";//恢復卡
text += "#v2635032##z2635032##r*20#b個  \r\n";//命運
text += "#v2633609##z2633609##r*3#b個   \r\n";//重載
text += "#v4001715##z4001715##r*2#b個   \r\n";//楓幣億
text += "#v2632486##z2632486##r*2#b個   \r\n";//翡翠寶石
text += "#v2431603##z2431603##r*5#b個   \r\n";//自選心
...
if (YN == 1) {
	if (true) {
		if (player.hasItem(boxId, 1)) {
			...
			//npc.broadcastPlayerNotice(10, "[九月暢玩禮包] 玩家 " + player.getName() + "  領取了暢玩九月單筆1000禮包!");
			player.gainItem(4032216, 9999);
			player.gainItem(4032053, 9999);
			player.gainItem(2644008, 1);
			player.gainItem(2049389, 1);
			player.gainItem(5064400, 20);
			player.gainItem(2635032, 20);
			player.gainItem(2633609, 3);
			player.gainItem(4001715, 2);
			player.gainItem(2632486, 2);
			player.gainItem(2431603, 5);
			player.gainItem(2632485, 3);
			player.addEventValue("九月1000贊助", 1, 30);
