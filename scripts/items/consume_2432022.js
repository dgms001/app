...
avail += "\t\t#b隨機力量[#r1-50#b]  隨機敏捷[#r1-50#b]  隨機智力[#r1-50#b]\r\n";
avail += "\t\t隨機幸運[#r1-50#b]  隨機物攻[#r1-50#b]  隨機魔攻[#r1-50#b]\r\n";
        ...
        if (flag == 1) {
            ...
            if (str < 可強化次數) {
                ...
                if (sel == 1) {
                    ...
                    if (chance0 < 85) {
                        equip.setStr(STR + getMinAndMax(1, 50));//力量
                    }
                    if (chance1 < 85) {
                        equip.setDex(DEX + getMinAndMax(1, 50));//敏捷
                    }
                    if (chance2 < 85) {
                        equip.setInt(INT + getMinAndMax(1, 50));//智力
                    }
                    if (chance3 < 85) {
                        equip.setLuk(LUK + getMinAndMax(1, 50));//運氣
                    }
                    if (chance4 < 85) {
                        equip.setPad(PAD + getMinAndMax(1, 50));//攻擊
                    }
                    if (chance5 < 85) {
                        equip.setMad(MAD + getMinAndMax(1, 50));//魔法攻擊
                    }
                    if (chance6 < 85) {
