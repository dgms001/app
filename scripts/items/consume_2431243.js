...
str = str.substring(0, 2);
            ...
            if (str < 可強化次數) {
                ...
                if (sel == 1) {
                    ...
                    if (chance0 < 85) {
                        equip.setStr(STR + getMinAndMax(30, 50));//力量
                    }
                    if (chance1 < 85) {
                        equip.setDex(DEX + getMinAndMax(30, 50));//敏捷
                    }
                    if (chance2 < 85) {
                        equip.setInt(INT + getMinAndMax(30, 50));//智力
                    }
                    if (chance3 < 85) {
                        equip.setLuk(LUK + getMinAndMax(30, 50));//運氣
                    }
                    if (chance4 < 85) {
                        equip.setPad(PAD + getMinAndMax(30, 50));//攻擊
                    }
                    if (chance5 < 85) {
                        equip.setMad(MAD + getMinAndMax(30, 50));//魔法攻擊
                    }
                    if (chance6 < 85) {
