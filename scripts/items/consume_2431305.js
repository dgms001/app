...
} else if (player.getFreeSlots(1) >= 2) {
    player.loseItem(2431305, 1);
    Gift(player.getJob());
    var txtA;
    txtA = "#fs18##b親愛的#r" + player.getName() + "\r\n";
    txtA += "#b#fs12#1.部分職業副手裝備不上的話\r\n";
    txtA += "#b#fs12#2.萬能選單-雜項功能-副手裝備\r\n";
    txtA += "#b#fs12#3.可以進行卸載於強裝\r\n";
    //player.addPopupSay(9112033, 15000, txtA, "");
    npc.askMenuA("\r\n\r\n\r\n\r\n\t\t\t\t#b#fs21##e送給你該職業基礎裝備，請注意查收！");
} else {
    npc.say("裝備欄背包空間不足,請確保有2個格子。");
}
function Gift(job) {
    switch (job) {
        case 13500: //雪吉拉(1轉)
        ...
        case 400: //盜賊(1轉)
            ...
            player.gainItem(2070000, 3);
            player.showProgressMessageFont("送了你3個海星標[自己去商店充值] ", 1, 30, 4, 10 * 1000);
            break;
        ...
        case 16212: //拉拉
            ...
            break;
        case 15400: //卡莉
            player.gainItem(1354030, 1);
            player.gainItem(1404000, 1);
            break;
        case 15410: //卡莉
            player.gainItem(1354031, 1);
            player.gainItem(1404001, 1);
            break;
        case 15411: //卡莉
            player.gainItem(1354032, 1);
            player.gainItem(1404004, 1);
            break;
        case 15412: //卡莉
            player.gainItem(1354033, 1);
            player.gainItem(1404011, 1);
            break;
    }
}