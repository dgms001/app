...
if (mapA == 993001100) { //限制開啟地圖
    ...
    player.gainItem(2049323, 40);
    player.gainItem(2630512, 8);
    player.gainItem(4009454, 1500);
    player.gainItem(4032053, 400);
    player.gainItem(4000444, 6000);
    player.gainItem(4009004, 10);
    player.gainItem(4009411, 3);
    player.gainItem(5062026, 15);
    player.loseItem(npc.getItemId())
    player.addEventValue("每日福利檢測", 1, 1);
    npc.broadcastPlayerNotice(37, "玩家" + player.getName() + " 獲得了每日3檔福利,當天不領隔天箱子自動刪除");
    if (getvalue() == 0) {
        insertitems(MAC, 1);
    } else {
        updateitems(MAC, 1);
