...
let maxPlayers = 6;
//等級限制
var minLevel = [230, 230];
var maxLevel = [300, 300];
//次數限制
var maxenter = [2, 2];
let BossName = "貝倫";
let PQLog = ["貝倫[普通]", "貝倫[困難]"];
let event = ["BossBelen_NORMAL", "BossBelen_CHAOS"];
let onlyOne = true;
...
text += "#fs17##e#b   普通血量:[#r800億#b]#fs17##e#b\t\t 困難血量:[#r6400億#b]\r\n";
text += "   全員獎勵(帳號限定):[#v4032053##v4001713##v4000540##v2630512#]\r\n";
//text += "#fs17##e#b混沌難度血量:[#r2400億#b] 專屬掉落物:[#v1003719##v2671093#]\r\n";
text += "   掉落獎勵:[#v2048815#]\r\n\r\n";
text += "";
text += "";
