...
if (mapA == 993001100) { //限制開啟地圖
    ...
    //let text = ""
    //text +="\t\t\t  "+SR3+"#fs32##fc0xFF00caf2##e《自選P寵系列》"+SR3+"\r\n";
    ...
    text = "\t" + Icon[17][1] + "#fs20##fc0xFF00caf2##e自選P寵系列" + Icon[17][1] + "#r#n\r\n";
    ...
    text += "#L0##v" + itemList[0] + "##z" + itemList[0] + "##l#L1##v" + itemList[1] + "##z" + itemList[1] + "##l#L2##v" + itemList[2] + "##z" + itemList[2] + "##l\r\n";

    text += "#L3##v" + itemList[3] + "##z" + itemList[3] + "##l #L4##v" + itemList[4] + "##z" + itemList[4] + "##l #L5##v" + itemList[5] + "##z" + itemList[5] + "##l\r\n";
    text += "#L6##v" + itemList[6] + "##z" + itemList[6] + "##l #L7##v" + itemList[7] + "##z" + itemList[7] + "##l #L8##v" + itemList[8] + "##z" + itemList[8] + "##l\r\n";
    text += "#L9##v" + itemList[9] + "##z" + itemList[9] + "##l #L10##v" + itemList[10] + "##z" + itemList[10] + "##l #L11##v" + itemList[11] + "##z" + itemList[11] + "##l\r\n";
    //text += "\t\t\t\t#L9##v" + itemList[9] + "##g#z" + itemList[9] + "##l←沒有SET效果";
}
