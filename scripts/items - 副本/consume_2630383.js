...
if (mapA == 993001100) { //限制開啟地圖
    ...
    text = ""
    text += "\t" + Icon[17][1] + "#fs20##fc0xFF00caf2#稱號系列" + Icon[17][1] + "#r\r\n";
    ...
    text += "#fs15#";
    text += "#r稱號自選對比選擇自己適合的,只有神話有爆傷\r\n"
    text += "#r選中即唯一,不可更換不要找GM更變\r\n"
    for (var i = 0; i <= 3; i++) {
        text += "#b#fs11##L" + i + "##v" + itemList[i] + "##b#z" + itemList[i] + "##l\r\n\r\n";
...
if (i >= 3 && player.getFreeSlots(3) < YN) {
    npc.say("裝飾欄不足1，請清理");
} else if (QSS >= YN) {
