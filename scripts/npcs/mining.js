...
switch (sel) {
    case 0:
        npc.sayNext("採礦是用十字鎬之類的工具，採集地圖上的礦石的技能。採集到的礦石，可以用#p9031007#出售的鐵砧進行冶煉，獲得裝備、飾品、鍊金術所需的材料。");
        break;
    case 1:
    ...
    case 3:
        if (player.getMakingSkillLevel(92020000) > 0) {
            npc.sayNext("你學習了裝備製作，現在無法初始化。真想初始化的話，就得先對裝備製作或飾品製作進行初始化。");
        } else {
    ...
    case 4:
        if (!player.hasItem(4011010, 100)) {
            npc.say("#b#t4011010#100個#k可以交換#i2028067:##b#t2028067#1個#k。請再去蒐集一些#t4011010#。");
