...
txt = "\r\n";
txt = "\t" + Icon[17][1] + "#fs20##fc0xFF00caf2##e人氣主播" + Icon[17][1] + "#r#n\r\n";
...
txt += "";
txt += "";
txt += "#L1#" + Icon[103][1] + "勳章強化#l #L2#" + Icon[103][1] + "直播獎勵#l";
txt += "#L3#" + Icon[103][1] + "直播分享獎勵#l\r\n\r\n\r\n\r\n";
txt += "" + Icon[43][1] + Icon[44][1] + Icon[45][1] + Icon[46][1] + Icon[47][1] + Icon[48][1] + Icon[49][1] + Icon[50][1]
    + Icon[51][1] + Icon[52][1] + Icon[53][1] + Icon[54][1] + Icon[55][1] + Icon[56][1] + Icon[57][1] + Icon[43][1] + Icon[44][1]
    + Icon[45][1] + Icon[46][1] + Icon[47][1] + Icon[48][1] + Icon[49][1] + Icon[50][1] + Icon[51][1] + Icon[52][1] + Icon[53][1]
    + Icon[54][1] + Icon[55][1] + Icon[56][1] + Icon[57][1] + Icon[47][1] + Icon[44][1] + "\r\n\r\n";
...
switch (selection) {
    case 1:
        player.runScript("直播勳章強化");
        break;

    case 2:
        txt = "#fs18##e#r首次直播獎勵如下↓\r\n#n";
        txt += "#fs14##b";
        txt += "#v2430066##z2430066#箱子:\r\n";
        txt += "#v1142499##z1142499#*1\r\n";
        txt += "#v4009411##z4009411#*5\r\n";
        txt += "#v4032053##z4032053#*1000\r\n";
        txt += "#v5062500##z5062500#*50\r\n";
        txt += "#v5064400##z5064400#*10\r\n";
        txt += "#v4009411##z4009411#*20\r\n\r\n";
        txt += "#fs18##e#r後續直播獎勵如下↓\r\n#n";
        txt += "#fs14##b";
        txt += "#v2430067##z2430067#:\r\n";
        txt += "#v4009411##z4009411#*3\r\n";
        txt += "#v4032053##z4032053#*500\r\n";
        txt += "#v5062500##z5062500#*30\r\n";
        txt += "#v5064400##z5064400#*5\r\n";
        txt += "#v4009411##z4009411#*5\r\n\r\n";
        txt += "";
        txt += "";

        let selection1 = npc.askMenu(txt, 9330114);
    ...
    case 3:
        txt = "#fs18##e#r直播分享獎勵如下↓\r\n#n";
        txt += "#fs14##b";
        txt += "#v2430068##z2430068#箱子:\r\n";
        txt += "#v5062009##z5062009#*30\r\n";
        txt += "#v5062010##z5062010#*30\r\n";
        txt += "#v4009454##z4009454#*2000\r\n";
        txt += "#v2472000##z2470000#*10\r\n";
        txt += "#v4032053##z4032053#*300\r\n";
        txt += "";
        txt += "";

        let selection2 = npc.askMenu(txt, 9330114);
        break;
