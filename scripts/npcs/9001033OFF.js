...
let mapA = map.getId();
txt ="\t"+Icon[17][1] +"#fs20##fc0xFF00caf2##e世界王"+Icon[17][1]+"#r#n\r\n";
...
txt +=  "  #fs11##L1#"+Icon[103][1] + "#b進入普通世界王#l\t\t#L2#"+Icon[103][1]+"#r進入困難世界王#l\r\n\r\n";
...
switch (selection) {
    case 1:
        player.runNpc("9001033");
        break;
    case 2:
       player.runNpc("9001033ON");
        break;
	case 20 :
		player.runScript("改版副本中心");
        break;
}
