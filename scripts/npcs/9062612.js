...
var text = head+"#fs21##e#r我可以幫助你回收裝備，回收裝備可以獲得#r回收材料#k。\r\n";
	text += "#r#L2#"+icon+" 回收說明#l\r\n";
	text += "#r#L1#"+icon+"【回收神秘】裝備#l\r\n";
	text += "#r#L3#"+icon+"【回收漆黑】裝備#l\r\n";
	//text += "#r#L4#"+icon+" 低級回收幣兌換#l\r\n";
	//text += "#r#L5#"+icon+" 高級回收幣兌換#l\r\n";
	text += "#r#L6#"+icon+" 一鍵回收【深淵系列】#l\r\n";
	text += "#r#L7#"+icon+" 一鍵回收【航海系列】#l\r\n";
...
function sayStr(){
	var text = "#e#r回收說明#n#k：\r\n\r\n\r\n";
	text += "#b深淵/航海系列裝備可以進行回收獲取楓幣。\r\n\r\n";
	text += "#b神秘裝備回收後可獲得#r1個#v4023025#\r\n\r\n";
	text += "#b漆黑裝備回收後可獲得#r1個#v4023026#\r\n";
	npc.askMenuA(text);
}
