...
let mapA = map.getId();
txt = "\t" + Icon[17][1] + "#fs20##fc0xFF00caf2##e賭狗地獄" + Icon[17][1] + "#r#n\r\n";
...
txt += "\t#fs11##L1#" + Icon[103][1] + "#r圓夢幣#l\t\t#L2#" + Icon[103][1] + "#b水果機#l\r\n\r\n";
txt += "\t  #fs11##L3#" + Icon[103][1] + "#r世界杯#l\r\n\r\n";
...
switch (selection) {
    case 1:
        ...
        break;
    case 2:
        player.runScript("水果機");
        break;
    case 3:
        player.runScript("LOL菠菜");
        break;
}
