...
if (equip1 == null) {
    ...
    if (selection == 0) {
        ...
        } else if (getQuestPoint(3886) < 1500) {
            npc.say("#fs16##b#e道場強化點數不足，無法購買");
        } else if (equip == null) {
