...
//modifyQuestPoint(3885,-4805000);
//player.showSystemMessage("增加了  道場點數，剩餘道場點數：" + getQuestPoint(3885));
...
var items = Array(
	...
	Array(4310260, 12, 1, "創世結晶"),
	Array(4034622, 9, 1, "250骷髏"),
	Array(5062503, 8, 1, "白色附加方塊"),
	Array(2434782, 5, 1, "白色附加碎片"),
	Array(2023745, 5, 1, "領路者5")
...
txt ="\t"+Icon[17][1] +"#fs20##fc0xFF00caf2#創世強化點"+Icon[17][1]+"#r#n\r\n";
...
txt += "#k#fs12##r                    武陵創世點數尚有：#r" + getQuestPoint(3885) +"#fs12##b#n\r\n";
for (var i = 1; i < items.length; i++) {
    txt += "#L" + i + "##b#v" + items[i][0] + "# #k#z" + items[i][0] + "##b #b[#r" + items[i][1] + "創世點數#b]#n\r\n";
}
let selection = npc.askMenuS(txt,true);
i = selection;
IT = getQuestPoint(3885)
...
if (i) {
    GS = selection;
    QSS = GS * items[i][1];
    if (getQuestPoint(3885) < QSS) {
        npc.say("#fs16##b#e創世點數不足，無法購買");
    } else {
		modifyQuestPoint(3885,-QSS);
		...
		player.showSystemMessage("剩餘創世點數：" + getQuestPoint(3885));
    }
}
