...
avail += "#b80%隨機力量[#r20-30#b]  80%隨機敏捷[#r20-30#b]  80%隨機智力[#r20-30#b]\r\n";
avail += "80%隨機幸運[#r20-30#b]  80%隨機物攻[#r20-30#b]  80%隨機魔攻[#r20-30#b]\r\n";
avail += "80%隨機B傷 [#r1-3#b]    80%隨機總傷[#r1-3#b]    80%隨機無視[#r1-3#b]\r\n";

avail +=  "#b提升需要#r#v4001715#*5/#v4001226#*10/#v4009357#*10/#v4036169#*5/#v4032053#*9999/#v4032216#*9999\r\n";
		...
		if (flag == 1) {
            ...
            if(times < 20) {
                ...
                if (sel == 1) {
                    ...
                    if (chance0 < 80) {
                        equip.setStr(STR + getMinAndMax(20, 30));//力量
                    }
                    if (chance1 < 80) {
                        equip.setDex(DEX + getMinAndMax(20, 30));//敏捷
                    }
                    if (chance2 < 80) {
                        equip.setInt(INT + getMinAndMax(20, 30));//智力
                    }
                    if (chance3 < 80) {
                        equip.setLuk(LUK + getMinAndMax(20, 30));//運氣
                    }
                    if (chance4 < 80) {
                        equip.setPad(PAD + getMinAndMax(20, 30));//攻擊
                    }
                    if (chance5 < 80) {
                        equip.setMad(MAD + getMinAndMax(20, 30));//魔法攻擊
                    }
                    if (chance6 < 80) {
                    ...
                    npc.broadcastGachaponMsgEx("【強化中心】 : 玩家 "+player.getName()+" 強化了黎明系列，獲得了強大的力量！！!", equip);
                    STR1 = equip.getStr();
                    DEX1 = equip.getDex();
                    INT1 = equip.getInt();
                    LUK1 = equip.getLuk();
