...
var status = 0;
var bossid = "全服獎勵";
var giftLevel = Array(200, 200, 100, 200);
var giftLevel2 = Array(1, 2, 3, 4);
var off = Array(0, 0, 1, 1);//開關 1為顯示 0為不顯示
var giftContent = Array(//力量.敏捷.致力.幸運.生命.魔力.物攻.魔攻.B傷.無視傷.總傷.星力
	...
	Array(
		Array(4009411, 10),//雪花
		Array(4001523, 50),	//怪物公園強化
		Array(4310075, 80),	//戰國強化
		Array(4000850, 10),	//蘇打
		Array(5062020, 50),	//閃炫
		Array(5062500, 50),//附加
		Array(5060029, 50),//艾比米修斯
		Array(5060048, 100),//蘋果
		Array(4032053, 3000)//楓夜水晶
	)
);
...
txt = "\t\t   " + SR3 + "#fs32##fc0xFF00caf2##e《全服獎勵》" + SR3 + "\r\n";
