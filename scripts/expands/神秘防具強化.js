...
var status = 0;
var level = Array(0, 1, 2, 3, 4);
var MaxLevel = 4;//這裡添加最大等級
var qianghuaname = "神秘防具強化";//顯示用 對應腳本名可以循環
var itemPQ = Array(
    //四維 攻魔 材料1 材料數量1 2 2 3 3 4 4 B傷 總傷 無視 楓幣
    Array(20, 25, 4310249, 1, 4250002, 8, 4032053, 700, 2250001, 15, 0, 0, 0, 0),
    Array(20, 25, 4310249, 2, 4250002, 10, 4032053, 800, 2250001, 18, 0, 0, 0, 0),
    Array(25, 30, 4310249, 2, 4250002, 12, 4032053, 900, 2250001, 20, 0, 0, 0, 0),
    Array(25, 30, 4310249, 3, 4250002, 15, 4032053, 1000, 2250001, 25, 0, 0, 0, 0),
    Array(30, 35, 4310249, 3, 4250002, 18, 4032053, 1100, 2250001, 30, 0, 0, 0, 0)
