...
/*let mapNames = Array( "隱藏的遺跡","死亡森林", "監視之塔", "龍之巢穴");
let maps = Array(953090000, 954010000, 954020000, 954030000);
let minLevel = Array(110, 120, 130, 140);
let maxLevel = Array(120, 130, 140, 150);
let minPlayers = 1;
let maxPlayers = 6;
let maxenter = 50;
