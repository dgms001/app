		...
		if (player.getFreeSlots(4) < 8) {
			...
			if (player.getEventValue("圓夢大改第一期草原1") < 5) {
				for (var i = 0; i < 5; i++) {
					...
					} else if (player.getEventValue("圓夢大改第一期草原1") < 5) {
						player.gainItem(item, foritem);
						player.loseItem(needitem, needcount100);
						player.addEventValue("圓夢大改第一期草原1", 1, 1000);
					}
			...
			if (player.getEventValue("圓夢大改第一期草原2") < 5) {
				for (var i = 0; i < 5; i++) {
					if (!player.hasItem(needitem, needcount150)) {
						npc.say("#fs14##b#v" + needitem + "##z" + needitem + "#不足");
					} else if (player.getEventValue("圓夢大改第一期草原2") < 5) {
						player.gainItem(item, foritem);
						player.loseItem(needitem, needcount150);
						player.addEventValue("圓夢大改第一期草原2", 1, 1000);
					}
			...
			if (player.getEventValue("圓夢大改第一期草原3") < 5) {
				for (var i = 0; i < 5; i++) {
					if (!player.hasItem(needitem, needcount200)) {
						npc.say("#fs14##b#v" + needitem + "##z" + needitem + "#不足");
					} else if (player.getEventValue("圓夢大改第一期草原3") < 5) {
						player.gainItem(item, foritem);
						player.loseItem(needitem, needcount200);
						player.addEventValue("圓夢大改第一期草原3", 1, 1000);
					}
			...
			if (player.getEventValue("圓夢大改第一期草原4") < 5) {
				for (var i = 0; i < 5; i++) {
					if (!player.hasItem(needitem, needcount220)) {
						npc.say("#fs14##b#v" + needitem + "##z" + needitem + "#不足");
					} else if (player.getEventValue("圓夢大改第一期草原4") < 5) {
						player.gainItem(item, foritem);
						player.loseItem(needitem, needcount220);
						player.addEventValue("圓夢大改第一期草原4", 1, 1000);
					}
			...
			if (player.getEventValue("圓夢大改第一期草原5") < 5) {
				for (var i = 0; i < 5; i++) {
					if (!player.hasItem(needitem, needcount230)) {
						npc.say("#fs14##b#v" + needitem + "##z" + needitem + "#不足");
					} else if (player.getEventValue("圓夢大改第一期草原5") < 5) {
						player.gainItem(item, foritem);
						player.loseItem(needitem, needcount230);
						player.addEventValue("圓夢大改第一期草原5", 1, 1000);
					}
			...
			if (player.getEventValue("圓夢大改第一期草原6") < 5) {
				for (var i = 0; i < 5; i++) {
					if (!player.hasItem(needitem, needcount240)) {
						npc.say("#fs14##b#v" + needitem + "##z" + needitem + "#不足");
					} else if (player.getEventValue("圓夢大改第一期草原6") < 5) {
						player.gainItem(item, foritem);
						player.loseItem(needitem, needcount240);
						player.addEventValue("圓夢大改第一期草原6", 1, 1000);
					}
			...
			if (player.getEventValue("圓夢大改第一期草原7") < 5) {
				for (var i = 0; i < 5; i++) {
					if (!player.hasItem(needitem, needcount250)) {
						npc.say("#fs14##b#v" + needitem + "##z" + needitem + "#不足");
					} else if (player.getEventValue("圓夢大改第一期草原7") < 5) {
						player.gainItem(item, foritem);
						player.loseItem(needitem, needcount250);
						player.addEventValue("圓夢大改第一期草原7", 1, 1000);
					}
