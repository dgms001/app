...
txt = "\t" + Icon[17][1] + "#fs20##fc0xFF00caf2#普通任務" + Icon[17][1] + "#r#n\r\n";
...
//txt ="\t\t\t  "+SR3+"#fs32##fc0xFF00caf2##e《普通任務》"+SR3+"\r\n";
...
txt += "#fs11#";
txt += "\t\t\t\t  #L4##r任務說明#l\r\n";
txt += "\t   #L1##b" + Icon[103][1] + "楓幣任務#l         #L2#" + Icon[103][1] + "楓點任務#l\r\n";
txt += "\t   #L5#" + Icon[103][1] + "真實符文任務#l     #L3#" + Icon[103][1] + "符文任務#l\r\n\r\n";
txt += "\t\t\t\t  #fs14##r#L10#【返回】#l\r\n\r\n";
txt += "" + Icon[43][1] + Icon[44][1] + Icon[45][1] + Icon[46][1] + Icon[47][1] + Icon[48][1] + Icon[49][1] + Icon[50][1]
    + Icon[51][1] + Icon[52][1] + Icon[53][1] + Icon[54][1] + Icon[55][1] + Icon[56][1] + Icon[57][1] + Icon[43][1] + Icon[44][1]
    + Icon[45][1] + Icon[46][1] + Icon[47][1] + Icon[48][1] + Icon[49][1] + Icon[50][1] + Icon[51][1] + Icon[52][1] + Icon[53][1]
...
switch (selection) {
    ...
    case 3:
        ...
        break;
    case 4:
        npc.say("#fs17##b#e[100等任務]單次獲得20經驗\r\n[200等任務]單次獲得30經驗\r\n[250等任務]單次獲得40經驗\r\n[285等任務]單次獲得50經驗\r\n");
        break;
    case 5:
        player.runScript("真實符文任務");
        break;
    case 10:
        player.runScript("改版主線任務");
        break;
