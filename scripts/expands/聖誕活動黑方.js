...
switch (selection) {
	...
	case 1:
		if (player.getLevel() < 210) {
		...
		} else if (player.getEventValue("聖誕活動黑色方塊1") >= 5) {
			...
			player.addEventValue("聖誕活動黑色方塊1", 1, 99);
	...
	case 2:
		if (player.getLevel() < 230) {
		...
		} else if (player.getEventValue("聖誕活動黑色方塊2") >= 5) {
			npc.say("#fs18##b#e活動期間次數已滿");
			...
			player.gainItem(itemIdS, 10);
			player.addEventValue("聖誕活動黑色方塊2", 1, 99);
			npc.say("#fs18##b#e獲得#g#v" + itemIdS + "##z" + itemIdS + "## #b* 10 個");
			addvalue(20);
		}
		break;
	case 3:
		if (player.getLevel() < 250) {
		...
		} else if (player.getEventValue("聖誕活動黑色方塊3") >= 5) {
			npc.say("#fs18##b#e活動期間次數已滿");
			...
			player.gainItem(itemIdS, 10);
			player.addEventValue("聖誕活動黑色方塊3", 1, 99);
			npc.say("#fs18##b#e獲得#g#v" + itemIdS + "##z" + itemIdS + "## #b* 10 個");
			addvalue(30);
		}
		break;
	case 4:
		if (player.getLevel() < 260) {
		...
		} else if (player.getEventValue("聖誕活動黑色方塊4") >= 5) {
			npc.say("#fs18##b#e活動期間次數已滿");
			...
			player.gainItem(itemIdS, 10);
			player.addEventValue("聖誕活動黑色方塊4", 1, 99);
			npc.say("#fs18##b#e獲得#g#v" + itemIdS + "##z" + itemIdS + "## #b* 10 個");
			addvalue(40);
		}
		break;
