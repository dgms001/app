...
txt = "#fs21##e#r你好,這裡是蘋果大獎回收!!!\r\n\r\n\r\n\r\n";

//txt += "\t\t\t#L0#" + d1 + "#l\r\n\r\n\r\n";

txt += "\t#L10#永恆防具回收#l  #L11#黎明飾品回收#l\r\n\r\n";//#L11#黎明飾品回收#l
...
function resolve10() {
    ...
    if (index_a <= 0) {
        ...
        if (bag(4) < 2) {
            ...
            player.loseInvSlot(parseInt(inventoryType), parseInt(deleteSlot));
            player.gainItem(4036167, 1);
            player.resetEventValue("永恆分解");
            txt = "#r回收成功，獲得了#v4036167 #X1個";
            npc.say(txt);
        }
    }
    resolve10();
...
function resolve11() {
    ...
    if (index_a <= 0) {
        ...
        if (bag(4) < 2) {
            ...
            player.loseInvSlot(parseInt(inventoryType), parseInt(deleteSlot));
            player.gainItem(4036169, 1);
            player.resetEventValue("黎明分解");
            txt = "#r回收成功，獲得了#v4036169 #X1個";
            npc.say(txt);
        }
    }
    resolve11();
