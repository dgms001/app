...
var itemid = 2432810; //所需物品

var days = 27; //day保持一致
var dayd = days + 1;
var days1 = "18 12:00:00"; //查看預測 每次開盤時間
/*
UPDATE dgms_lolbocai SET `now`='0' WHERE ZhanduiName = "阿根廷" AND date >= '2022-12-18 12:00:00';
 */

var xuanshou1 = "阿根廷";
var xuanshoupeilv1 = 1.67;
var xuanshou2 = "法國";
var xuanshoupeilv2 = 1.38;
//隔天三點
var xuanshou3 = "摩洛哥";
var xuanshoupeilv3 = 4.32;
var xuanshou4 = "法國";
var xuanshoupeilv4 = 1.33;
/*
var xuanshou5 = "塞爾維亞";
var xuanshoupeilv5 = 2.42;
var xuanshou6 = "瑞士";
var xuanshoupeilv6 = 1.98;

var xuanshou7 = "喀麥隆";
var xuanshoupeilv7 = 6.22;
var xuanshou8 = "巴西";
var xuanshoupeilv8 = 1.31;



var xuanshou9 = "波瀾";
var xuanshoupeilv9 = 5.66;
var xuanshou10 = "阿根廷";
var xuanshoupeilv10 = 1.39;

var xuanshou11 = "沙特阿拉伯";
var xuanshoupeilv11 = 4.3;
var xuanshou12 = "墨西哥";
var xuanshoupeilv12 = 1.61;
*/
while (true) {
    txt = "   " + Icon[17][1] + "#fs14##fc0xFF00caf2##e世界杯[總決賽]" + Icon[17][1] + "#r#n\r\n";
    ...
    if ((day <= days && hour < 23)) {
        //txt += "#fs12##r#L1#" + xuanshou1 + "賠率[" + xuanshoupeilv1 + "] VS#l #L2#" + xuanshou2 + "賠率[" + xuanshoupeilv2 + "] 23:00封盤#l\r\n";
    }

    if ((day < dayd || hour < 03)) {
        // txt += "#fs12##b#L3#" + xuanshou3 + "賠率[" + xuanshoupeilv3 + "] VS#l #L4#" + xuanshou4 + "賠率[" + xuanshoupeilv4 + "] 03:00封盤#l\r\n";
    }
    /*
    if ((day < dayd || hour < 03)) {
        txt += "#fs12##b#L5#" + xuanshou5 + "賠率[" + xuanshoupeilv5 + "] VS#l #L6#" + xuanshou6 + "賠率[" + xuanshoupeilv6 + "] 03:00封盤#l\r\n";
    }
    if ((day < dayd || hour < 03)) {
        txt += "#fs12##b#L7#" + xuanshou7 + "賠率[" + xuanshoupeilv7 + "] VS#l #L8#" + xuanshou8 + "賠率[" + xuanshoupeilv8 + "] 03:00封盤#l\r\n";
    }
	
    if ((day <= dayd && hour < 3)) {
        txt += "#fs12##b#L9#" + xuanshou9 + "賠率[" + xuanshoupeilv9 + "] VS#l #L10#" + xuanshou10 + "賠率[" + xuanshoupeilv10 + "] 03:00封盤#l\r\n";
    }
    if ((day <= dayd && hour < 3)) {
        txt += "#fs12##L11#" + xuanshou11 + "賠率[" + xuanshoupeilv11+ "] VS#l #L12#" + xuanshou12 + "賠率[" + xuanshoupeilv12+ "] 3:00封盤#l\r\n";
    }
    */

    //txt += "  #fs13##r#L13#我要領獎#l #L14#兌換#z2432810##l #L15#兌換#z4009411##l\r\n";
    txt += "#r\t\t\t  #L16#查看我的當期預測#l\r\n\r\n";
    txt += "#r必看說明:每天最後一場結束後結算+開新的盤口\r\n";
    txt += "#r領取代號不會重複,重複可以聯繫GM檢舉,後台也會查詢\r\n\r\n";
    txt += "" + Icon[43][1] + Icon[44][1] + Icon[45][1] + Icon[46][1] + Icon[47][1] + Icon[48][1] + Icon[49][1] + Icon[50][1]
        + Icon[51][1] + Icon[52][1] + Icon[53][1] + Icon[54][1] + Icon[55][1] + Icon[56][1] + Icon[57][1] + Icon[43][1] + Icon[44][1]
        + Icon[45][1] + Icon[46][1] + Icon[47][1] + Icon[48][1] + Icon[49][1] + Icon[50][1] + Icon[51][1] + Icon[52][1] + Icon[53][1]
        + Icon[54][1] + Icon[55][1] + Icon[56][1] + Icon[57][1] + Icon[47][1] + Icon[44][1] + "\r\n\r\n";
    ...
    switch (selection) {
        case 1:
            var currentItemQuantity = player.getAmountOfItem(2432810);
            txt = "\r\n\t\t  #fs24##r#e【投注" + xuanshou1 + "】\r\n";
            txt += "#fs16##b當前賠率:" + xuanshoupeilv1 + ",最低投注100\r\n\r\n";
            txt += "請輸入要投注的數量:[當前盈虧 " + player.getEventValue("足球投注總量") + "]";
            txt += "";
            var number = npc.askNumber(txt, 100, 100, currentItemQuantity);
            var peilv = number * xuanshoupeilv1;
            if (!player.hasItem(2432810, number)) {
                npc.say("物品不足,你在幹嘛呢???");
            } else if (hour == 23) {
                npc.say("已封盤,你在幹嘛呢???");
            } else {
                player.loseItem(2432810, number);
                player.addEventValue("足球投注總量", -number, 1000);
                player.customSqlInsert("INSERT INTO `dgms_lolbocai` (`nameid`,`type`, `num`,`max`,`now`,`ZhanduiName`,`date`) VALUES ('" + player.getAccountId() + "','2432810', '" + peilv + "','1','1','" + xuanshou1 + "',now())");
                addLOLBC(-number);
                npc.say("投注成功");
            }
            break;
        case 2:
            ...
            if (!player.hasItem(2432810, number)) {
                ...
                player.loseItem(2432810, number);
                player.addEventValue("足球投注總量", -number, 1000);
                player.customSqlInsert("INSERT INTO `dgms_lolbocai` (`nameid`,`type`, `num`,`max`,`now`,`ZhanduiName`,`date`) VALUES ('" + player.getAccountId() + "','2432810', '" + peilv + "','1','1','" + xuanshou2 + "',now())");
                addLOLBC(-number);
                npc.say("投注成功");
            }
            break;
        case 3:
            ...
            if (!player.hasItem(2432810, number)) {
                ...
                player.loseItem(2432810, number);
                player.addEventValue("足球投注總量", -number, 1000);
                player.customSqlInsert("INSERT INTO `dgms_lolbocai` (`nameid`,`type`, `num`,`max`,`now`,`ZhanduiName`,`date`) VALUES ('" + player.getAccountId() + "','2432810', '" + peilv + "','1','1','" + xuanshou3 + "',now())");
                addLOLBC(-number);
                npc.say("投注成功");
            }
            break;
        case 4:
            ...
            if (!player.hasItem(2432810, number)) {
                ...
                player.loseItem(2432810, number);
                player.addEventValue("足球投注總量", -number, 1000);
                player.customSqlInsert("INSERT INTO `dgms_lolbocai` (`nameid`,`type`, `num`,`max`,`now`,`ZhanduiName`,`date`) VALUES ('" + player.getAccountId() + "','2432810', '" + peilv + "','1','1','" + xuanshou4 + "',now())");
                addLOLBC(-number);
                npc.say("投注成功");
            }
            break;
        case 5:
            ...
            if (!player.hasItem(2432810, number)) {
                ...
                player.loseItem(2432810, number);
                player.addEventValue("足球投注總量", -number, 1000);
                player.customSqlInsert("INSERT INTO `dgms_lolbocai` (`nameid`,`type`, `num`,`max`,`now`,`ZhanduiName`,`date`) VALUES ('" + player.getAccountId() + "','2432810', '" + peilv + "','1','1','" + xuanshou5 + "',now())");
                addLOLBC(-number);
                npc.say("投注成功");
            }
            break;
        case 6:
            ...
            if (!player.hasItem(2432810, number)) {
                ...
                player.loseItem(2432810, number);
                player.addEventValue("足球投注總量", -number, 1000);
                player.customSqlInsert("INSERT INTO `dgms_lolbocai` (`nameid`,`type`, `num`,`max`,`now`,`ZhanduiName`,`date`) VALUES ('" + player.getAccountId() + "','2432810', '" + peilv + "','1','1','" + xuanshou6 + "',now())");
                addLOLBC(-number);
                npc.say("投注成功");
            }
            break;
        case 7:
            ...
            if (!player.hasItem(2432810, number)) {
                ...
                player.loseItem(2432810, number);
                player.addEventValue("足球投注總量", -number, 1000);
                player.customSqlInsert("INSERT INTO `dgms_lolbocai` (`nameid`,`type`, `num`,`max`,`now`,`ZhanduiName`,`date`) VALUES ('" + player.getAccountId() + "','2432810', '" + peilv + "','1','1','" + xuanshou7 + "',now())");
                addLOLBC(-number);
                npc.say("投注成功");
            }
            break;
        case 8:
            ...
            if (!player.hasItem(2432810, number)) {
                ...
                player.loseItem(2432810, number);
                player.addEventValue("足球投注總量", -number, 1000);
                player.customSqlInsert("INSERT INTO `dgms_lolbocai` (`nameid`,`type`, `num`,`max`,`now`,`ZhanduiName`,`date`) VALUES ('" + player.getAccountId() + "','2432810', '" + peilv + "','1','1','" + xuanshou8 + "',now())");
                addLOLBC(-number);
                npc.say("投注成功");
            }
            break;
        case 9:
            ...
            if (!player.hasItem(2432810, number)) {
                ...
                player.loseItem(2432810, number);
                player.addEventValue("足球投注總量", -number, 1000);
                player.customSqlInsert("INSERT INTO `dgms_lolbocai` (`nameid`,`type`, `num`,`max`,`now`,`ZhanduiName`,`date`) VALUES ('" + player.getAccountId() + "','2432810', '" + peilv + "','1','1','" + xuanshou9 + "',now())");
                addLOLBC(-number);
                npc.say("投注成功");
            }
            break;
        case 10:
            ...
            if (!player.hasItem(2432810, number)) {
                ...
                player.loseItem(2432810, number);
                player.addEventValue("足球投注總量", -number, 1000);
                player.customSqlInsert("INSERT INTO `dgms_lolbocai` (`nameid`,`type`, `num`,`max`,`now`,`ZhanduiName`,`date`) VALUES ('" + player.getAccountId() + "','2432810', '" + peilv + "','1','1','" + xuanshou10 + "',now())");
                addLOLBC(-number);
                npc.say("投注成功");
            }
            break;
        case 11:
            ...
            if (!player.hasItem(2432810, number)) {
                ...
                player.loseItem(2432810, number);
                player.addEventValue("足球投注總量", -number, 1000);
                player.customSqlInsert("INSERT INTO `dgms_lolbocai` (`nameid`,`type`, `num`,`max`,`now`,`ZhanduiName`,`date`) VALUES ('" + player.getAccountId() + "','2432810', '" + peilv + "','1','1','" + xuanshou11 + "',now())");
                addLOLBC(-number);
                npc.say("投注成功");
            }
            break;
        case 12:
            ...
            if (!player.hasItem(2432810, number)) {
                ...
                player.loseItem(2432810, number);
                player.addEventValue("足球投注總量", -number, 1000);
                player.customSqlInsert("INSERT INTO `dgms_lolbocai` (`nameid`,`type`, `num`,`max`,`now`,`ZhanduiName`,`date`) VALUES ('" + player.getAccountId() + "','2432810', '" + peilv + "','1','1','" + xuanshou12 + "',now())");
                addLOLBC(-number);
                npc.say("投注成功");
            }
            break;
        ...
        case 14:
            ...
            txt = "\r\n\t\t  #fs24##r#e【餘額交換】\r\n";
            txt += "#fs16##g#v4009411##z4009411##b 換 #v2432810##z2432810# X 100\r\n\r\n";
            txt += "為防止上頭每日限購500次\r\n";
            txt += "請輸入兌換的數量:";
            txt += "";
            ...
            if (!player.hasItem(4009411, number)) {
                npc.say("物品不足,不他嗎想啥呢???");
            } else if (player.getFreeSlots(2) < number / 99) {
                npc.say("您的消耗背包其他欄空間不足,請保證欄位至少(" + number / 99 + ")格的空間。");
            } else if ((player.getEventValue("防上頭") + number) > 500) {
                npc.say("今天超過500餘額的注量,請明日再來");
            } else {
                player.loseItem(4009411, number);
                player.gainItem(2432810, number * 100);
                player.addEventValue("防上頭", number, 1);
                npc.say("兌換成功");
            }
            break;
        case 15:
            var currentItemQuantity = player.getAmountOfItem(2432810);
            txt = "\r\n\t\t  #fs24##r#e【卡片交換】\r\n";
            txt += "#fs16##g#v2432810##z2432810# X 100 #b 換 #v4009411##z4009411#\r\n\r\n";
            txt += "請輸入兌換的數量:";
            txt += "";
            var number = npc.askNumber(txt, 1, 1, currentItemQuantity / 100);
            if (!player.hasItem(2432810, number * 100)) {
                npc.say("物品不足,不他嗎想啥呢???");
            } else {
                player.loseItem(2432810, number * 100);
...
function test() {
    var sql = "select * from dgms_lolbocai where nameid = '" + player.getAccountId() + "' and date >= '2022-12-" + days1 + "'";
...
function jianglifasong() {
    ...
    for (let i = 0; i < push.size(); i++) {
        let signle = push.get(i);
        if (signle.get("nameid") == player.getAccountId()) {
            str += "#L" + i + "# #r預測中" + signle.get("ZhanduiName") + "的獎勵#z2432810# X " + signle.get("num") + "#l\r\n";
    ...
    if (push.size() > 0) {
        ...
        if (player.getFreeSlots(2) < (signle.get("num") / 9999)) {
            npc.say("您的消耗背包消耗欄空間不足,請保證欄位至少(" + signle.get("num") / 9999 + ")格的空間。");
        } else {
            //存數據庫
            ...
            player.addEventValue("足球投注總量", signle.get("num"), 1000);
            addLOLBC(signle.get("num"));
            player.gainItem(type, parseInt(signle.get("num").toString()));
            npc.broadcastPlayerNotice(37, "玩家" + player.getName() + " 投中 [" + signle.get("ZhanduiName") + "] 獲得:" + parseInt(signle.get("num").toString()) + "好運球 代號:[" + signle.get("id") + "]");
