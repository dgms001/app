...
var maxenter = [4, 2];
let BossName = "血腥女王";
let PQLog = ["血腥女王[普通]", "血腥女王[困難]"];
let event = ["BossBloody_NORMAL","BossBloody_CHAOS"];
let onlyOne = true;
...
if (map.getId() == startmap) {
		...
		text += "#fs17##e#b普通難度BOSS血量:[#r3.15億#b] 專屬物品:[#v2630367##v3010514#]\r\n";
		text += "";
		text += "#fs17##e#b困難難度BOSS血量:[#r1400億#b] 專屬物品:[#v2630370##v3991064#]\r\n";
		text += "";
		text += "";
		text += "";
