...
txt = "\t\t\t  " + SR3 + "#fs32##fc0xFF00caf2##e#r《新年活動》" + SR4 + "\r\n";
...
txt += "#e#fs17#";//v2630646
txt += "#b任務屬性:[活動期間限定次數]\t\r\n#fc0xFFFFF300#";
txt += "#L0#" + GC1 + "新年活動#v5062009##l\t#L1#" + GC1 + "新年活動#v5062010##l\t#L2#" + GC1 + "新年活動#v5062017##l\r\n";
txt += "#L3#" + GC1 + "新年活動#v5062020##l\t #L4#" + GC1 + "新年活動#v2630648##l\t#L5#" + GC1 + "新年活動#v4009454##l\r\n";
txt += "#b#r\t\t\t\t\t【特殊】#fc0xFFFFF300#\r\n";
//txt += "#b#r\t\t\t\t\t初一開放#fc0xFFFFF300#\r\n";
txt += "#L6#" + GC1 + "新年活動#v2630649##l\t#L7#" + GC1 + "新年活動#v5064400##l\t#L8#" + GC1 + "新年活動#v5062500##l\r\n";
if (player.isGm()) {
...
switch (selection) {
	...
	case 0:
		player.runScript("新年活動紅方");
		break;
	case 1:
		player.runScript("新年活動黑方");
		break;
	case 2:
		player.runScript("新年活動閃耀方");
		break;
	case 3:
		player.runScript("新年活動閃炫");
		break;
	case 4:
		player.runScript("新年活動V卷");
		break;
	case 5:
		player.runScript("新年活動草原");
		break;
	case 6:
		player.runScript("新年活動B卷");
		break;
	case 7:
		player.runScript("新年活動恢復");
		break;
	case 8:
		player.runScript("新年活動附加");
		break;
