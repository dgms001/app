...
str += "#b2.此技能為[#r破壞的雅達巴特#b]\r\n";
str += "解封材料如下:\r\n";

str += "#v4310107##z4310107##r*5#b  #v4310218##z4310218##r*20#b\r\n";
str += "#v4000732##z4000732##r*4000#b#v4000733##z4000733##r*4000#b\r\n";
...
if (YN == 1) {
	...
	} else if (!player.hasItem(4000732, 4000)) {
       npc.say("#v4000732##z4000732#不足。");
	} else if (!player.hasItem(4000733, 4000)) {
       npc.say("#v4000733##z4000733#不足。");
         ...
         if (toDrop1 == null) {
            ...
            npc.say("第一格裝備不是#r解封的創世武器#k型別");
                ...
                //player.setKeyValue("UWB", "1") //UWB創造無敵
					...
					player.loseItem(4000732, 4000);
					player.loseItem(4000733, 4000);
					player.loseItem(4000743, 4000);
					player.loseItem(4000739, 4000);
					player.loseItem(4032053, 20000);
					player.loseItem(4001715, 10);
                    npc.broadcastPlayerNotice(13,"[創世技能解封]  玩家家: "+player.getName()+"  成功解除創世技能破壞");
