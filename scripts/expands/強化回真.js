...
txt = "";
txt = "#fs21##e#r你好,這裡是強化裝備回真!!!\r\n";
txt += "#fs16##e#b漆黑回真收取#v4009411##r*200#b個 楓點#r2000#b萬 楓幣#r20#b億[#r保留潛能#b]\r\n";
txt += "銀河/培羅德/神秘回真收取#v4009411##r*100#b個 楓點#r2000#b萬 楓幣#r10#b億[#r不保留潛能#b]\r\n";

txt += "\t\t\t\t#L0#回真說明#l\r\n";
txt += "#L1#強化回真[#r銀河副手#b]#l   #L11#強化回真[#r培羅德飾品#b]#l\r\n";
txt += "#L6#強化回真[#r神秘武器#b]#l   #L5#強化回真[#r神秘防具#b]#l\r\n";
txt += "#L4#強化回真[#r漆黑飾品#b]#l\r\n\r\n";
//txt += "#L2#強化回真[#r永恆防具#b]#l   #L3#強化回真[#r黎明飾品#b]#l\r\n";
//txt += "#L7#回真[女 武 神]#r剩" + (1 - player.getEventValue("女武神")) + "次#k#l#L8#回真[ 漆  黑 ]#r剩" + (4 - player.getEventValue("漆黑")) + "次#k#l\r\n\r\n";
//txt += "#L9#回真[波 賽 頓]#r剩" + (2 - player.getEventValue("波塞頓")) + "次#k#l#L10#回真[大魔戒指]#r剩" + (1 - player.getEventValue("大魔戒指")) + "次#k#l\r\n\r\n";
//txt += "#L11#回真[培 羅 德]#r剩" + (4 - player.getEventValue("培羅德")) + "次#k#l#L12#回真[天上氣息]#r剩" + (1 - player.getEventValue("天上氣息")) + "次#k#l\r\n\r\n";
//txt += "#L13#回真[永    恆]#r剩" + (4 - player.getEventValue("永恆")) + "次#k#l\r\n\r\n";
//txt += "\t\t\t#L0#回真中心說明#l\r\n\r\n";
///txt += "#L1#回真[深淵防具]#r剩" + (4 - player.getEventValue("深淵防具")) + "次#k#l#L2#回真[深淵武器]#r#r剩" + (1 - player.getEventValue("深淵武器")) + "次#k#k#l\r\n\r\n";
//txt += "#L3#回真[航海防具]#r剩" + (4 - player.getEventValue("航海防具")) + "次#k#l#L4#回真[航海武器]#r剩" + (1 - player.getEventValue("航海武器")) + "次#k#l\r\n\r\n";
...
function resolve1() {
    ...
    if (index_a <= 0) {
        ...
        if (bag(4) < 6) { //這裡也要改一下
        ...
        } else if (player.getEventValue("銀河副手") >= 9999) {
            npc.say("#fs18##b#e回真次數已上限,無法回真。");
        } else if (!player.hasItem(4009411, 100)) {
            npc.say("餘額幣不足。");
        } else if (player.getCashShopCurrency(2) < 20000000) {
            npc.say("楓點不足2000萬!!!");
            ...
            //這裡給強化道具
            player.gainItem(4001872, 1 * get);
            player.gainItem(4001227, 10 * get);
            player.gainItem(4032053, 5000 * get);
            player.gainItem(4032216, 9999 * get);
            //這裡給強化道具
            player.modifyCashShopCurrency(2, -20000000);
            player.loseMesos(1000000000);
            player.loseItem(4009411, 100);
            player.addEventValue("銀河副手", 1, 3000);
            npc.broadcastPlayerNotice(3, "[銀河副手回真]  玩家  " + player.getName() + "  回真了銀河副手!!!");

            txt = "#fs18##b#e回真成功,強化材料返還背包";
            npc.say(txt);
...
function resolve2() {
    ...
    if (index_a <= 0) {
        ...
        if (bag(4) < 6) { //這裡也要改一下
            npc.say("#fs18##b#e其他欄格子不足6，請整理後分解。");;
        } else if (!player.hasItem(4009411, 10)) {
            npc.say("餘額幣不足。");
        } else if (player.getEventValue("永恆防具") >= 999999) {
            npc.say("#fs18##b#e回真次數已上限,無法回真。");
        } else if (player.getCashShopCurrency(2) < 20000000) {
            npc.say("楓點不足2000萬!!!");
        } else if (!player.hasMesos(2000000000)) {
            npc.say("楓幣不足20E");
        } else if (item.getAttribute() == 1) {
            npc.say("#fs18##b#e帶鎖的裝備不能進行操作。");
        } else if (get == 0 || get == null) {
            ...
            toGain = player.makeItemWithId(item.getDataId());
            toGain.setOption1(item.getOption1());
            toGain.setOption2(item.getOption2());
            toGain.setOption3(item.getOption3());
            toGain.setGrade(item.getGrade())
            toGain.setOption4(item.getOption4());
            toGain.setOption5(item.getOption5());
            toGain.setOption6(item.getOption6());
            player.gainItem(toGain);
            player.loseInvSlot(1, 1);
            //這裡給強化道具
            player.gainItem(4001715, 5 * get);
            player.gainItem(4001226, 10 * get);
            player.gainItem(4036167, 10 * get);
            player.gainItem(4031875, 5 * get);
            player.gainItem(4032053, 9999 * get);
            player.gainItem(4032216, 9999 * get);
            //這裡給強化道具
            player.modifyCashShopCurrency(2, -20000000);
            player.loseMesos(2000000000);
            player.loseItem(4009411, 10);
            player.addEventValue("永恆防具", 1, 3000);
            npc.broadcastPlayerNotice(3, "[永恆防具回真]  玩家  " + player.getName() + "  回真了永恆防具!!!");
...
function resolve3() {
    ...
    if (index_a <= 0) {
        ...
        if (bag(4) < 8) { //這裡也要改一下
            ...
            npc.say("餘額幣不足。");
        } else if (player.getEventValue("黎明飾品") >= 999999) {
            npc.say("#fs18##b#e回真次數已上限,無法回真。");
        } else if (player.getCashShopCurrency(2) < 20000000) {
            npc.say("楓點不足2000萬!!!");
        } else if (!player.hasMesos(2000000000)) {
            ...
            player.gainItem(4001715, 5 * get);
            player.gainItem(4001226, 10 * get);
            player.gainItem(4036169, 10 * get);
            player.gainItem(4031875, 5 * get);
            player.gainItem(4032053, 9999 * get);
            player.gainItem(4032216, 9999 * get);
            //這裡給強化道具
            ...
            player.loseMesos(2000000000);
            player.loseItem(4009411, 10);
            player.addEventValue("黎明飾品", 1, 3000);
            npc.broadcastPlayerNotice(3, "[黎明飾品回真]  玩家  " + player.getName() + "  回真了黎明飾品!!!");
...
function resolve4() {
    ...
    if (index_a <= 0) {
        ...
        if (bag(4) < 8) { //這裡也要改一下
            npc.say("#fs18##b#e其他欄格子不足8，請整理後分解。");;
		} else if (!player.hasItem(4009411, 200)) {
            npc.say("餘額幣不足。");
        } else if (player.getEventValue("漆黑飾品") >= 999999) {
            npc.say("#fs18##b#e回真次數已上限,無法回真。");
        } else if (player.getCashShopCurrency(2) < 20000000) {
            npc.say("楓點不足2000萬!!!");
        } else if (!player.hasMesos(2000000000)) {
            ...
            player.gainItem(4001872, 1 * get);
            player.gainItem(4021019, 10 * get);
            player.gainItem(4032053, 5000 * get);
            player.gainItem(4032216, 9999 * get);
            player.gainItem(4023026, 5 * get);

            //這裡給強化道具
			player.modifyCashShopCurrency(2, -20000000);
            player.loseMesos(2000000000);
            player.loseItem(4009411, 200);
            player.addEventValue("漆黑飾品", 1, 3000);
			npc.broadcastPlayerNotice(3, "[漆黑飾品回真]  玩家  " + player.getName() + "  回真了漆黑飾品!!!");
...
function resolve5() {
    ...
    if (index_a <= 0) {
        ...
        if (bag(4) < 7) { //這裡也要改一下
        ...
        } else if (player.getEventValue("神秘防具") >= 9999) {
            npc.say("#fs18##b#e回真次數已上限,無法回真。");
        } else if (!player.hasItem(4009411, 100)) {
            npc.say("餘額幣不足。");
        } else if (player.getCashShopCurrency(2) < 20000000) {
            ...
            //這裡給強化道具
            player.gainItem(4001872, 1 * get);
            player.gainItem(4001229, 5 * get);
            player.gainItem(4032053, 5000 * get);
            player.gainItem(4032216, 9999 * get);
            player.gainItem(4023025, 5 * get);
            //這裡給強化道具
            player.modifyCashShopCurrency(2, -20000000);
            player.loseMesos(1000000000);
            player.loseItem(4009411, 100);
            player.addEventValue("神秘防具", 1, 3000);
            npc.broadcastPlayerNotice(3, "[神秘防具回真]  玩家  " + player.getName() + "  回真了神秘防具!!!");
            txt = "#fs18##b#e回真成功,強化材料返還背包";
            npc.say(txt);
...
function resolve6() {
    ...
    if (index_a <= 0) {
        ...
        if (bag(4) < 7) { //這裡也要改一下
            npc.say("#fs18##b#e其他欄格子不足7，請整理後分解。");;
        } else if (player.getEventValue("神秘武器") >= 9999) {
            npc.say("#fs18##b#e回真次數已上限,無法回真。");
        } else if (!player.hasItem(4009411, 100)) {
            npc.say("餘額幣不足。");
        } else if (player.getCashShopCurrency(2) < 20000000) {
            ...
            //這裡給強化道具
            player.gainItem(4001872, 1 * get);
            player.gainItem(4001229, 10 * get);
            player.gainItem(4032053, 5000 * get);
            player.gainItem(4032216, 9999 * get);
            player.gainItem(4023025, 5 * get);
            //這裡給強化道具
            ...
            npc.broadcastPlayerNotice(3, "[神秘武器回真]  玩家  " + player.getName() + "  回真了神秘武器!!!");
...
function resolve7() {
    ...
    if (index_a <= 0) {
        ...
        if (bag(4) < 7) { //這裡也要改一下
            ...
            player.gainItem(4033078, 1000 * get);
...
function resolve8() {
    ...
    if (index_a <= 0) {
        ...
        if (bag(4) < 15) { //這裡也要改一下
            ...
            player.gainItem(4033078, 50000 * get);
...
function resolve10() {
    ...
    if (index_a <= 0) {
        ...
        if (bag(4) < 5) { //這裡也要改一下
            ...
            player.loseInvSlot(parseInt(inventoryType), parseInt(deleteSlot));
            //這裡給強化道具
            player.gainItem(4033078, 888 * get);
...
function resolve11() {
    ...
    if (index_a <= 0) {
        ...
        if (bag(4) < 7) { //這裡也要改一下
            npc.say("#fs18##b#e其他欄格子不足7，請整理後分解。");;
        } else if (player.getEventValue("培羅德") >= 9999) {
            npc.say("#fs18##b#e回真次數已上限,無法回真。");
        } else if (!player.hasItem(4009411, 100)) {
            npc.say("餘額幣不足。");
        } else if (player.getCashShopCurrency(2) < 20000000) {
            ...
            //這裡給強化道具
            player.gainItem(4001872, 1 * get);
            player.gainItem(4001228, 10 * get);
            player.gainItem(4032053, 5000 * get);
            player.gainItem(4032216, 9999 * get);
            //這裡給強化道具
            player.modifyCashShopCurrency(2, -20000000);
            ...
            npc.broadcastPlayerNotice(3, "[培羅德回真]  玩家  " + player.getName() + "  回真了培羅德飾品!!!");
            txt = "#fs18##b#e回真成功,強化材料返還背包";
            npc.say(txt);
...
function resolve12() {
    ...
    if (index_a <= 0) {
        ...
        if (bag(4) < 6) { //這裡也要改一下
            ...
            player.gainItem(4033078, 3000 * get);
            player.gainItem(4021032, 1000 * get);
...
function sayStr() {
    var txt = "";
    txt += "#fs21##b#e";
    txt += "#r裝備有丟過翡翠寶石的不能返還!!!!#b\r\n";
    txt += "強化材料根據強化等級來返還對等的強化材料\r\n";
    txt += "潛能 星力 捲軸 金錘子等這些全部不返還\r\n";
    txt += "不懂私訊GM,不懂私訊GM,不懂私訊GM\r\n\r\n";
    txt += "不可逆向操作,確定好在回真!!!\r\n";
    txt += "不可逆向操作,確定好在回真!!!\r\n";
    txt += "不可逆向操作,確定好在回真!!!\r\n";
    npc.askMenuA(txt);
