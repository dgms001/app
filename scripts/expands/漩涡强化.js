...
avail += "#b這裡是漩渦眼飾或臉飾屬性提升中心:#v1022211##v1012438#\r\n\r\n#k";
...
avail += "5、#r注意：把要提升的漩渦眼飾或臉飾放在裝備欄的第一個位置！\r\n#k";
avail += " #L0##b我要強化漩渦眼飾或臉飾！#l#k\r\n#k";
	...
	if (!player.hasItem(need, 10) || !player.hasItem(need2, 2) || !player.hasItem(need3, 1000)) {
		...
		if (flag == 1) {
			...
			if (times < 10) {
				...
				info += "\r\n#b強化:#k 最大值#g-> #r本次";
				info += "\r\n#b力量:#k最大值:3 #g-> #r" + randList[0];
				info += "\r\n#b敏捷:#k最大值:3 #g-> #r" + randList[1];
				info += "\r\n#b智力:#k最大值:3 #g-> #r" + randList[2];
				info += "\r\n#b運氣:#k最大值:3 #g-> #r" + randList[3];
				info += "\r\n#b攻擊力:#k最大值:3 #g-> #r" + randList[4];
				info += "\r\n#b魔法力:#k最大值:3 #g-> #r" + randList[5];
				...
				if (sel == 1) {
					...
					npc.broadcastGachaponMsgEx("【強化中心】 : 玩家 " + player.getName() + " 強化了漩渦眼飾或臉飾，獲得了強大的力量！！!", equip);
