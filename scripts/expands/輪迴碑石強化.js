...
avail+="#b#fs21#這裡是深淵武器,防具屬性提升中心:#v1202193#\r\n\r\n#k";
avail +="#b#fs16#每次提升屬性\r\n[力量#r+5#b＆敏捷#r+5#b＆智力#r+5#b＆運氣#r+5#b＆物攻#r+5#b＆魔攻#r+5#b]\r\n";
		avail += "#b提升屬性需要#r#v" + need + "#*1，#v" + need2 + "#*5，#v" + need3 + "#*5000，#v" + need4 + "#*9999\r\n\r\n";
...
//			npc.say("你並沒有#z" + need + "#，所以不能開啟"+player.hasItem(need,1)+player.hasItem(need2,1)+player.hasItem(need3,1000));
			...
			if(times < 10) {
				...
				info += "\r\n#b全屬性:#k最大值:2 #g-> #r" + 2*/;
				info += "\r\n#b最大HP:#k最大值:100 #g-> #r" + randList[8];
				info += "\r\n#b最大MP:#k最大值:100 #g-> #r" + randList[9];
				...
				if(sel == 1) {
					...
					equip.setCHUC(equip.getCHUC() + randList[10]);
					
					times++;
					//equip.setStatR(times*2);
					equip.setTitle("強化+" + times);
					player.updateItem(1, equip);
					npc.broadcastGachaponMsgEx("【強化中心】 : 玩家 "+player.getName()+" 強化了輪迴石碑，獲得了強大的力量！！!", equip);
