...
var item3 = Array(2612089,2612090,2613076,2613077,2615060,2615061,2616224,2616225,2048848,2048849);//獲得 x捲
var seng =  25;//機率
var cash1 = 60000;

var itemb = 4002001;//需求道具b中
var itembb = Array(2048825, 2048826, 2612080, 2612081, 2613068, 2613069, 2616216, 2616217, 2615051, 2615052);//v捲
var seng1 = 30;
var cash2 = 20000;
		...
		/*if (number > player.getAmountOfItem(item2)) {
		 ...
		 if (player.getCashShopCurrency(2) <= number * cash1) {
			...
			for (var i = 1; i < number + 1; i++) {
				...
				player.addEventValue("卷軸強化-Y卷軸", 1, 1000);
