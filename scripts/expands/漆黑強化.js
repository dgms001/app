...
avail += "#b#fs21#這裡是漆黑,防具屬性提升中心:#v1162083##v1032316#\r\n\r\n#k";
avail += "#b#fs16#每次提升屬性\r\n[力量#r+30#b＆敏捷#r+30#b＆智力#r+30#b＆運氣#r+30#b＆物攻#r+30#b＆魔攻#r+30#b]\r\n[BOSS傷害#r+3#b＆無視#r+3#b＆總傷害#r+3#b]\r\n";
		...
		if (flag == 1) {
			...
			if (times < 15) {
				...
				if (sel == 1) {
					...
					npc.broadcastGachaponMsgEx("【強化中心】 : 玩家 " + player.getName() + " 強化了漆黑系列，獲得了強大的力量！！!", equip);
