                ...
                if (flag == 1) {
                    ...
                    if (str < 可強化次數) {
                        ...
                        if (sel == 1) {
                            ...
                            //BOSS傷害
                            equip.setBossDamageR(BossDamageR + randList[6]);
                            //無視
                            equip.setIgnorePDR(IgnorePDR + randList[7]);
                            //總傷%
