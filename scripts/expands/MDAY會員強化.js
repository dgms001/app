...
if (equip1 == null) {
    ...
    avail += "#n\r\n#r需要武陵點數 [10000] 當前擁有:" + getQuestPoint(3887) + "\r\n\r\n";
    avail += "#n\r\n#r需要樂豆 [200] 當前擁有:" + player.getCashShopCurrency(1) + "\r\n\r\n";
    avail += "每次強化提升：\r\n力量[#r" + randList[0] + "#b] 敏捷[#r" + randList[1] + "#b] 智力[#r" + randList[2] + "#b]\r\n幸運[#r" + randList[3] + "#b] 物攻[#r" + randList[4] + "#b] 魔攻[#r" + randList[5] + "#b] \r\nB傷 [#r" + randList[6] + "#b ] 無視%[#r" + randList[7] + "#b] 卷數[#r" + randList[9] + "#b ] \r\n可強化次數:[#r" + 可強化次數 + "#b]\r\n";
    avail += "#r機率:60%成功,40%失敗不變#n\r\n\r\n";
    ...
    if (selection == 0) {
        ...
        if (!player.hasItem(ItemSl[0][0], ItemSl[0][1])) {
            ...
            npc.say("#fs18##b#e你並沒有足夠的材料所以不能強化");
        } else if (getQuestPoint(3887) < 10000) {
            npc.say("#fs16##b#e道場點數不足10000，無法強化");
        } else if (player.getCashShopCurrency(1) < 200) {
            npc.say("#fs16##b#e樂豆不足200，無法強化");
        } else if (equip == null) {
                ...
                if (str < 可強化次數) {
                    ...
                    if (sel == 1) {
                        ...
                        if (send < send00) {
                            ...
                            modifyQuestPoint(3887, -10000);
                            player.modifyCashShopCurrency(1, -200);
