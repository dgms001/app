...
txt += "#fs16##L1##b" + a23 + "圖騰製作#l\r\n";
txt += "#fs16##L2##b" + a23 + "圖騰升級一#l\r\n";
txt += "#fs16##L3##b" + a23 + "圖騰升級二#l\r\n";
txt += "#fs16##L4##b" + a23 + "圖騰升級三#l\r\n";
txt += "#fs16##L5##b" + a23 + "圖騰升級四#l\r\n";
txt += "#fs16##L6##b" + a23 + "圖騰升級五#l\r\n";
...
switch (selection) {
    case 1:
        ...
        break;
    case 2:
	    player.runScript("圖騰1");
        break;
    case 3:
        player.runScript("圖騰2");
        break;
    case 4:
        player.runScript("圖騰3");
        break;
    case 5:
        player.runScript("圖騰4");
        break;
    case 6:
        player.runScript("圖騰5");
        break;
    case 7:
