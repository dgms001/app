...
var maxenter = [1, 1];
let BossName = "巴洛谷";
let PQLog = ["巴洛谷[普通]", "巴洛谷[困難]"];
let event = ["BossBalrog_NORMAL", "BossBalrog_HARD"];
let onlyOne = true;
...
text += "#fs17##e#b普通難度血量:[#r700萬#b]#fs17##e#b困難難度血量:[#r6億#b]\r\n專屬掉落物:[#v1072375##v2671051#]\r\n排名獎勵:[#v4001714##v4021009##v4032056#]尾刀獎勵:[#v4310273#]\r\n";
text += "";
//text += "#fs17##e#b困難難度血量:[#r6億#b] 專屬掉落物:[#v1072375##v2671051#]\r\n";
text += "";
text += "";
text += "";
