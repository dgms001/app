...
var jobData = new Array(
        ...
        //Array("卡莉(1轉)", 15400 , 15003,10),
        //Array("卡莉(2轉)", 15410 , 15400,30),
        //Array("卡莉(3轉)", 15411 , 15410,60),
        //Array("卡莉(4轉)", 15412 , 15411,100),
...
if (flag) {
        let sel = npc.askMenuA(text,9330576);
        let ret = npc.askMenuA("#b#fs24##e您是否要轉職為:" + jobData[sel][0] + "\r\n\r\n\r\n\r\n\t\t\t\t#L1##r確認請點擊#l",9330576);
        if (ret == 1) {
