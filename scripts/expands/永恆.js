...
avail += "#b#fs21#這裡是永恆防具屬性提升中心\r\n\r\n#k";
avail += "#b#fs16#每次提升屬性\r\n[力量#r+40#b＆敏捷#r+40#b＆智力#r+40#b＆運氣#r+40#b＆物攻#r+40#b＆魔攻#r+40#b]\r\n[BOSS傷害#r+1#b＆無視#r+1#b＆總傷害#r+1#b]\r\n";
avail += "#b提升屬性需要#r#v" + need + "#*5，#v" + need1 + "#*9999，#v" + need2 + "#*9999，#v" + need3 + "#*5，#v" + need4 + "#*5，#v" + need5 + "#*10\r\n\r\n";
...
if (selection == 0) {
	...
	if (!player.hasItem(need, 5) || !player.hasItem(need1, 9999)|| !player.hasItem(need2, 9999)|| !player.hasItem(need3, 5) || !player.hasItem(need4, 5) || !player.hasItem(need5, 10)) {
		...
		if (flag == 1) {
			...
			if (times < 10) {
				...
				info += "\r\n#bBOSS傷害:#k最大值:1 #g-> #r" + randList[6];
				info += "\r\n#b無視:#k最大值:1 #g-> #r" + randList[7];
				info += "\r\n#b總傷:#k最大值:1 #g-> #r" + randList[8];
				info += "\r\n#b最大HP:#k最大值:500 #g-> #r" + randList[9];
				info += "\r\n#b最大MP:#k最大值:500 #g-> #r" + randList[10];
				...
				if (sel == 1) {
					...
					npc.broadcastGachaponMsgEx("【強化中心】 : 玩家 " + player.getName() + " 強化了永恆防具，獲得了強大的力量！！!", equip);

					player.loseItem(need, 5);
					player.loseItem(need1, 9999);
					player.loseItem(need2, 9999);
					player.loseItem(need3, 5);
					player.loseItem(need4, 5);
