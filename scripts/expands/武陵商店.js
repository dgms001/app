...
//modifyQuestPoint(3887,-4805000);
//player.showSystemMessage("增加了  道場點數，剩餘道場點數：" + getQuestPoint(3887));
...
var items = Array(
	...
	//Array(4009455, 500, 1, "楓之谷世界的元素:山脈"),
	...
	Array(2022862, 500, 1, ""),
	Array(2022863, 500, 1, ""),
	Array(2022864, 1500, 1, ""),
	Array(2450164, 1000, 1, "經驗值3倍15分"),
	Array(2450163, 2000, 1, "經驗值3倍30分"),
	//Array(2631182, 2000, 1, "武陵飾品箱"),
	Array(4132001, 800, 1, "女神之力-潛能之鎖"),
	Array(4033732, 3000, 1, "輪迴強化道具"),
	Array(2049384, 15000, 1, "15星"),
	Array(3018466, 30000, 1, "武陵椅子"),
	Array(3015241, 30000, 1, "武陵椅子"),
	Array(3015240, 30000, 1, "武陵椅子"),
	Array(3018465, 30000, 1, "武陵椅子")
...
//txt = "" + GC1 + GC1 + GC1 + GC1 + "\r\n";
//txt = "\r\n";
//txt += "\t\t    #e#fs20##r"+zx4+"【武陵商店】"+zx4+"\r\n\r\n#n";
//txt += "" +zx7+zx7+zx7+zx7+zx7+zx7+zx7+zx7+zx7+zx7+zx7+zx7+zx7+zx7+ "\r\n";

txt = "#e#fs21##r武陵道場點數尚有：#r" + getQuestPoint(3887) +"#fs16##b#n\r\n";
for (var i = 1; i < items.length; i++) {
    txt += "#L" + i + "##b#v" + items[i][0] + "# #b#e#z" + items[i][0] + "##b #b[#r" + items[i][1] + "道場點數#b]#n\r\n";
}
let selection = npc.askMenuA(txt,true);
i = selection;
IT = getQuestPoint(3887)
IG= Math.floor(IT/items[i][1]);
selection = npc.askNumber("#fs14##b購買道具為：#v" + items[i][0] + "# #z" + items[i][0] + "#\r\n可購買數量:[#r"+IG+"#b]\r\n#b請輸入購買個數：", 1, 1, 999);

if (i) {
    GS = selection;
    QSS = GS * items[i][1];
    if (getQuestPoint(3887) < QSS) {
        npc.say("#fs16##b#e道場點數不足，無法購買");
    } else {
		modifyQuestPoint(3887,-QSS);
		...
		player.showSystemMessage("剩餘道場點數：" + getQuestPoint(3887));
    }
}
