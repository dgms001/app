...
var items = Array(
    ...
    Array(4002000, 1, 5, "捲軸升級材料低"),
    Array(4002001, 2, 5, "捲軸升級材料中"),
    Array(4002002, 3, 5, "捲軸升級材料高"),


    Array(80000565, 300, 1, 2, "攻擊力增加30", 5),
    Array(80000566, 1000, 3, 4, "爆率概率增加45%", 5),
    Array(80000567, 1000, 3, 4, "暴擊傷害增加24%", 5),
    Array(80000568, 1000, 3, 4, "BOSS傷害增加45%", 5),
    Array(80000569, 1000, 3, 4, "無視防禦率增加45%", 5),
    Array(80000570, 1000, 3, 4, "BUFF持續時間增加45%", 5),
);

var itemsl = player.getPQLog("BOSS里程");
txt = "";

txt += "多人組隊通關BOSS後傷害第一名獲取BOSS里程,單人沒有里程\r\n";

txt += "#b當前擁有 [ #r" + itemsl + "#b ] 里程\r\n";
for (var i = 1; i <= 3; i++) {
