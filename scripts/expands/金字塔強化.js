...
if (equip == null) {
    ...
    itemid = 0;
} else if (equip.getDataId() != 1002430 && equip.getDataId() != 1022228 && equip.getDataId() != 1012325) {
    npc.askMenuS("只有#v1002430##v1022228##v1012325#才可以強化！");
} else if (equip != null) {
