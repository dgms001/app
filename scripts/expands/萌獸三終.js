...
if (toDrop1 == null) {
    ...
    txt += "#b請先封印一次在速洗\r\n";
    txt += "#b一鍵滿級萌獸需要100萬楓點\r\n";
    txt += "#b好潛能[#g綠字#b] 一般潛能[#r紅字#b] 普通潛能[藍字]\r\n\r\n";

    txt += "\t#b#L1#一鍵滿級萌獸#l  #L2#速洗萌獸#l  #L5#萌獸背包#l\r\n\r\n";//#L1#" + f2 + "一鍵升級#l      
    ...
    case 2:
        while (true) {
            var Potential = Array(
                ...
                Array("#k全屬性+20", 40016),
                Array("#k4秒內恢復20HP", 40016),
                Array("#k4秒內恢復20MP", 40016),
                Array("#bSTR+14%", 40016),
                Array("#bDEX+14%", 40016),
                Array("#bINT+14%", 40016),
                Array("#bLUK+14%", 40016),
                Array("#bMaxHP+14%", 40016),
                Array("#bMaxMP+14%", 40016),
                Array("#kDEX+1%", 40016),
                Array("#kDEX+1%", 40016),
                Array("#r物攻+14%", 40016),
                Array("#r魔攻+14%", 40016),
                Array("#b防禦力+14%", 40016),
                Array("#b防禦力+14%", 40016),
                Array("#k攻擊有3%概率恢復50HP", 40016),
                Array("#k攻擊有3%概率恢復50MP", 40016),
                Array("#k攻擊有12%概率發動中毒效果", 40016),
                Array("#k攻擊有12%概率發動眩暈效果", 40016),
                Array("#k攻擊有12%概率發動緩慢效果", 40016),
                Array("#k攻擊有12%概率發動暗黑效果", 40016),
                Array("#k攻擊有12%概率發動冰結效果", 40016),
                Array("#k攻擊有12%概率發動封印效果", 40016),
                Array("#b無視怪物防禦率+45%", 40016),
                Array("#k依角色攻擊力的90%追加萌獸攻擊力", 40016),
                Array("#b依角色全部屬性的90%追加萌獸攻擊力", 40016),
                Array("#r加持技能持續時間+50%", 40016),
                Array("#k依照被動技能2來增加", 40016),
                Array("#k全屬性+20", 40016),
                Array("#k4秒內恢復20HP", 40016),
                Array("#k4秒內恢復20MP", 40016),
                Array("#bSTR+14%", 40016),
            ...
            if (!player.hasItem(5743003, 1)) {
               npc.say("萌獸方塊不足!!!");
                ...
                var PotentiaA = getMinAndMax(0, 200); //再次減少最終傷害概率
    ...
    case 3:
        ...
        if (yes == 1) {
            if (!player.hasMesos(100000000)) {
                ...
                npc.say("外形修改成功,請換線刷新,否則可能無效自行承擔後果");
            }
        }
        break;
    case 4:
