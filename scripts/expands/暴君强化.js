...
avail += "#b這裡是大暴君屬性提升中心:#v1132177##v1102484##v1102483##v1102481#\r\n\r\n#k";
...
avail += "5、#r注意：把要提升的大暴君放在裝備欄的第一個位置！\r\n#k";
avail += " #L0##b我要強化大暴君！#l#k\r\n#k";
		...
		if (flag == 1) {
			...
			if (times < 10) {
				...
				if (sel == 1) {
					...
					npc.broadcastGachaponMsgEx("【強化中心】 : 玩家 " + player.getName() + " 強化了大暴君，獲得了強大的力量！！!", equip);
