...
if (equip == null) {
    npc.askMenuS("只能對270等級獎勵勛章使用！");
}
//avail += "" + a8 + "  " + a888 + "" + a888 + "" + a888 + " " + a88 + "";
//avail += "#r說明:#b需要的材料如下:\r\n";
avail += "#b將#v1142242#放到第一格\r\n";

for (var i = 0; i < ItemSl.length; i++) {
    avail += "#v" + ItemSl[i][0] + "# 需要 [ #r" + ItemSl[i][1] + " #b] \r\n";
}
avail += "為勛章增加#bB傷 #r20% #b 無視 #r20%#b  總傷 #r20%#b #b\r\n";
avail += "\t\t\t\t#r#L0#點我增加#l#k\r\n\r\n#k";
//avail += "" + a8 + "  " + a888 + "" + a888 + "" + a888 + " " + a88 + "";
let selection = npc.askMenuA(avail);
if (selection == 0) {
    equip = player.getInventorySlot(1, 1);
    if (equip.getDataId() != 1142242) {
        npc.say("裝備欄第一格不為勛章#v1142242#");
        ...
        if (flag == 1) {
            ...
            if (str < 可強化次數) {
                ...
                info += "\r\n#b附魔B傷:#k#g+ #r" + randList[0];
                info += "\r\n#b附魔無視:#k#g+ #r" + randList[1];
                info += "\r\n#b附魔總傷:#k#g+ #r" + randList[2];
                ...
                if (sel == 1) {
					...
					equip.setExpiration(new Date().getTime() + 1000 * 60 * 60 * 24 * 30);
