...
var items = Array(
    ...
    Array(2023743, 5, 1, "領路者3階段"),
    Array(2048761, 3, 1, "輪迴星火"),
    Array(2472000, 3, 1, "白金槌子"),

    Array(2433575, 50, 1, "自選榮耀卷"),
    Array(5064400, 10, 1, "恢復卡"),

    Array(2049389, 300, 1, "20星力"),
    //Array(2630635,500,1, "自選P寵"),


);
var itemsl = 4310071;
//txt = "\r\n";
//txt += "\t\t    #e#fs20##r"+zx4+"【OX幣商店】"+zx4+"\r\n#n";
//txt += "" +zx7+zx7+zx7+zx7+zx7+zx7+zx7+zx7+zx7+zx7+zx7+zx7+zx7+zx7+ "\r\n";
txt = "\t" + Icon[17][1] + "#fs20##fc0xFF00caf2#OX商店" + Icon[17][1] + "#r#n\r\n";
