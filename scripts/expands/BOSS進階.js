...
var bosswarp = Array(//BOSS傳送
        ...
        Array(25, "黑魔法師#l", 255, 450012500, true, "黑魔法師難度選擇"),
        Array(28, "賽蓮#l", 265, 450012500, true, "賽蓮難度選擇"),
		Array(29, "天使守護水靈#l", 275, 450012500, true, "綠水靈進場"),
		Array(30, "卡洛斯#l", 280, 450012500, true, "卡洛斯難度選擇"));
var txt = "#b";
txt += "\t" + Icon[17][1] + "#fs15##fc0xFF00caf2##e  進  階  " + Icon[17][1] + "#r#n\r\n";
txt += "#b#fs11##e";
...
txt += "#L26##fUI/UIWindow2.img/UserList/Main/Boss/BossList/" + bosswarp[26][0] + "/Icon/" + (bosswarp[26][4] ? "normal" : "disabled") + "/0#" + bosswarp[26][1] + "#l\r\n\r\n";
txt += "#L27##fUI/UIWindow2.img/UserList/Main/Boss/BossList/" + bosswarp[27][0] + "/Icon/" + (bosswarp[27][4] ? "normal" : "disabled") + "/0#" + bosswarp[27][1] + "#l";
txt += "#L28##fUI/UIWindow2.img/UserList/Main/Boss/BossList/" + bosswarp[28][0] + "/Icon/" + (bosswarp[28][4] ? "normal" : "disabled") + "/0#" + bosswarp[28][1] + "#l\r\n\r\n";
txt += "" + Icon[43][1] + Icon[44][1] + Icon[45][1] + Icon[46][1] + Icon[47][1] + Icon[48][1] + Icon[49][1] + Icon[50][1]
+Icon[51][1] + Icon[52][1] + Icon[53][1] + Icon[54][1] + Icon[55][1] + Icon[56][1] + Icon[57][1] + Icon[43][1] + Icon[44][1]
+Icon[45][1] + Icon[46][1] + Icon[47][1] + Icon[48][1] + Icon[49][1] + Icon[50][1] + Icon[51][1] + Icon[52][1] + Icon[53][1]
+Icon[54][1] + Icon[55][1] + Icon[56][1] + Icon[57][1] + Icon[47][1] + Icon[44][1] + "\r\n";
