...
var bosswarp = Array(//BOSS傳送
        ...
        //Array(20, "庫洛斯#l  ", 160, 806300000, true, "庫洛斯進場"),
        Array(10, "梅格耐斯#l", 115, 401060000, true, "梅格耐斯進場"),
        //Array(14, "烏勒斯#l  ", 100, 970072200, true, "烏勒斯進場"),
...
var txt = "#b";
//#fUI/UIWindow4.img/GrowHelp/Maximum/boss_wnd/BtBoss/bossImg/" + bosswarp[i][0] + "/0#
//txt += "#fUI/UIWindow2.img/UserList/Main/Boss/BossList/" + bosswarp[i][0] + "/Icon/" + (bosswarp[i][4] ? "normal" : "disabled") + "/0#";
txt += "\t" + Icon[17][1] + "#fs15##fc0xFF00caf2##e  中  階  " + Icon[17][1] + "#r#n\r\n";
txt += "#b#fs11##e";
...
txt += "#L11##fUI/UIWindow2.img/UserList/Main/Boss/BossList/" + bosswarp[11][0] + "/Icon/" + (bosswarp[11][4] ? "normal" : "disabled") + "/0#" + bosswarp[11][1] + "#l ";
txt += "#L12##fUI/UIWindow2.img/UserList/Main/Boss/BossList/" + bosswarp[12][0] + "/Icon/" + (bosswarp[12][4] ? "normal" : "disabled") + "/0#" + bosswarp[12][1] + "#l ";
txt += "#L13##fUI/UIWindow2.img/UserList/Main/Boss/BossList/" + bosswarp[13][0] + "/Icon/" + (bosswarp[13][4] ? "normal" : "disabled") + "/0#" + bosswarp[13][1] + "#l\r\n\r\n";
txt += "#L14##fUI/UIWindow2.img/UserList/Main/Boss/BossList/" + bosswarp[14][0] + "/Icon/" + (bosswarp[14][4] ? "normal" : "disabled") + "/0#" + bosswarp[14][1] + "#l";
txt += "#L15##fUI/UIWindow2.img/UserList/Main/Boss/BossList/" + bosswarp[15][0] + "/Icon/" + (bosswarp[15][4] ? "normal" : "disabled") + "/0#" + bosswarp[15][1] + "#l ";
txt += "#L16##fUI/UIWindow2.img/UserList/Main/Boss/BossList/" + bosswarp[16][0] + "/Icon/" + (bosswarp[16][4] ? "normal" : "disabled") + "/0#" + bosswarp[16][1] + "#l\r\n\r\n";
txt += "" + Icon[43][1] + Icon[44][1] + Icon[45][1] + Icon[46][1] + Icon[47][1] + Icon[48][1] + Icon[49][1] + Icon[50][1]
+Icon[51][1] + Icon[52][1] + Icon[53][1] + Icon[54][1] + Icon[55][1] + Icon[56][1] + Icon[57][1] + Icon[43][1] + Icon[44][1]
+Icon[45][1] + Icon[46][1] + Icon[47][1] + Icon[48][1] + Icon[49][1] + Icon[50][1] + Icon[51][1] + Icon[52][1] + Icon[53][1]
+Icon[54][1] + Icon[55][1] + Icon[56][1] + Icon[57][1] + Icon[47][1] + Icon[44][1] + "\r\n";
//txt += "\t\t\t\t#e#fs24##fc0xFFFFF300#【高級Boss】\r\n";
//txt += "#b#fs17##e";
//txt += "#L17##fUI/UIWindow2.img/UserList/Main/Boss/BossList/" + bosswarp[17][0] + "/Icon/" + (bosswarp[17][4] ? "normal" : "disabled") + "/0#"+bosswarp[17][1]+"#l";
//txt += "#L18##fUI/UIWindow2.img/UserList/Main/Boss/BossList/" + bosswarp[18][0] + "/Icon/" + (bosswarp[18][4] ? "normal" : "disabled") + "/0#"+bosswarp[18][1]+"#l";
//txt += "#L19##fUI/UIWindow2.img/UserList/Main/Boss/BossList/" + bosswarp[19][0] + "/Icon/" + (bosswarp[19][4] ? "normal" : "disabled") + "/0#"+bosswarp[19][1]+"#l";
//txt += "#L20##fUI/UIWindow2.img/UserList/Main/Boss/BossList/" + bosswarp[20][0] + "/Icon/" + (bosswarp[20][4] ? "normal" : "disabled") + "/0#"+bosswarp[20][1]+"#l\r\n\r\n";
//txt += "";
//txt += "\t\t\t\t#e#fs24##fc0xFFFFF300#【終極Boss】\r\n";
//txt += "#b#fs17##e";
//txt += "#L21##fUI/UIWindow2.img/UserList/Main/Boss/BossList/" + bosswarp[21][0] + "/Icon/" + (bosswarp[21][4] ? "normal" : "disabled") + "/0#"+bosswarp[21][1]+"#l";
//txt += "#L22##fUI/UIWindow2.img/UserList/Main/Boss/BossList/" + bosswarp[22][0] + "/Icon/" + (bosswarp[22][4] ? "normal" : "disabled") + "/0#"+bosswarp[22][1]+"#l";
//txt += "#L23##fUI/UIWindow2.img/UserList/Main/Boss/BossList/" + bosswarp[23][0] + "/Icon/" + (bosswarp[23][4] ? "normal" : "disabled") + "/0#"+bosswarp[23][1]+"#l";
//txt += "#L24##fUI/UIWindow2.img/UserList/Main/Boss/BossList/" + bosswarp[24][0] + "/Icon/" + (bosswarp[24][4] ? "normal" : "disabled") + "/0#"+bosswarp[24][1]+"#l";
//txt += "#L25##fUI/UIWindow2.img/UserList/Main/Boss/BossList/" + bosswarp[25][0] + "/Icon/" + (bosswarp[25][4] ? "normal" : "disabled") + "/0#"+bosswarp[25][1]+"#l";
//txt += "";
