...
var status = 0;
var level = Array(0, 1, 2, 3, 4, 5, 6, 7);
var MaxLevel = 7;//這裡添加最大等級
var qianghuaname = "馬車強化";//顯示用 對應腳本名可以循環
var itemPQ = Array(
    //四維 攻魔 材料1 材料數量1 2 2 3 3 4 4 B傷 總傷 無視 楓幣
    Array(8, 10, 4009396, 100, 4009393, 100, 4032053, 3000, 2250001, 5, 1, 1, 1, 50000000),
    Array(10, 15, 4009396, 100, 4009393, 100, 4032053, 5000, 2250001, 10, 1, 1, 1, 100000000),
    Array(12, 18, 4009396, 200, 4009393, 200, 4032053, 8000, 2250001, 15, 1, 1, 1, 150000000),
    Array(15, 20, 4009396, 200, 4009393, 200, 4032053, 10000, 4031917, 15, 1, 1, 1, 200000000),
    Array(20, 25, 4009396, 300, 4009393, 300, 4032053, 15000, 4031917, 20, 2, 2, 2, 300000000),
    Array(25, 30, 4009396, 300, 4009393, 300, 4032053, 20000, 4031917, 30, 2, 2, 2, 400000000),
    Array(30, 35, 4009396, 400, 4009393, 400, 4032053, 25000, 4031917, 40, 3, 3, 3, 500000000),
    Array(35, 40, 4009396, 400, 4009393, 400, 4032053, 30000, 4031917, 50, 4, 4, 4, 600000000),
