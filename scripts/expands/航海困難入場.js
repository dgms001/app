...
//text += ""+XC01;
var text = "\t" + Icon[17][1] + "#fs20##fc0xFF00caf2##e致命海盜船" + Icon[17][1] + "#r#n\r\n";
...
text += "#fs11##n";
text += "\t\t\t\t#b通關完成獎勵如下:\r\n";
text += "\t\t\t#v2633634#*3 #v4034622#*3 #v5062010#*30\r\n";
text += "\t\t\t100圓夢經驗,150公會貢獻點\r\n";
text += "\t\t#r#fs11##L0##e進入海盜船內部[限時20分]#l\r\n\r\n";
text += "#fs11##n";
//text += "\t\t#g#L1#"+Icon[103][1]+"兌換航海飾品#l  #L2#"+Icon[103][1]+"航海飾品強化#l\r\n\r\n";
text += "" + Icon[43][1] + Icon[44][1] + Icon[45][1] + Icon[46][1] + Icon[47][1] + Icon[48][1] + Icon[49][1] + Icon[50][1]
    + Icon[51][1] + Icon[52][1] + Icon[53][1] + Icon[54][1] + Icon[55][1] + Icon[56][1] + Icon[57][1] + Icon[43][1] + Icon[44][1]
    + Icon[45][1] + Icon[46][1] + Icon[47][1] + Icon[48][1] + Icon[49][1] + Icon[50][1] + Icon[51][1] + Icon[52][1] + Icon[53][1]
    + Icon[54][1] + Icon[55][1] + Icon[56][1] + Icon[57][1] + Icon[47][1] + Icon[44][1] + "\r\n\r\n";
...
if (sel == 0) {
    ...
    text = "#fs16##b兌換航海飾品需要#r#v4310100##z4310100##b*150個\r\n\r\n";
    text += "";
    text += "";
    text += "#L0##v1012438##z1012438#兌換#l\r\n";
    text += "#L1##v1022211##z1022211#兌換#l\r\n";
    var change = npc.askMenu(text);
    switch (change) {
        case 0:
            if (!player.hasItem(4310100, 150)) {
                npc.say("#fs14##b#v4310100##z4310100#不足");
            } else {
                player.gainItem(1012438, 1);
                player.loseItem(4310100, 150);
                npc.say("兌換成功");
            }
            break;
        case 1:
