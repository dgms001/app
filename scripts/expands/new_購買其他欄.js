...
function start() {
    ...
    var sql = " SELECT iid, a.itemid, sn, a.meso,number FROM dgms_sale a WHERE type = 4 AND buy_id IS NULL ORDER BY paytime DESC ";
    var resultList = player.customSqlResult(sql);
    var text = "#fs21##e#b請選擇你要購買的道具(#r#e不能拆分購買#n)\r\n";
