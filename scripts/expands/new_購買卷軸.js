...
function start() {
    ...
    var sql = " SELECT iid, a.itemid, sn, a.meso,number FROM dgms_sale a WHERE type = 2 AND buy_id IS NULL ORDER BY paytime DESC ";
    var resultList = player.customSqlResult(sql);
    var text = "#fs14##b請選擇你要購買的道具(#r#e不能拆分購買#k#n)\r\n";
    text += "#fs14##r#v4000236##z4000236#這是跑環材料,非機器人的強化材料\r\n";
