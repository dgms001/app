 ...
 * qq:381991414
 */
let MAP_ID = 401060100;
let EXIT_MAP = 401060000;
let mobId = 8880002; //增加
let bossHp = 101000000000; //增加
var bossid = "梅格耐斯[普通]";
...
let end;
let totalTime = 0;
let BOSS_LOG = "boss_magnus";
var bossname = "梅格耐斯[普通]";
let DEATH_COUNT = 5;
var tupoTotal = 0;
let members;
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            /*
                        if (player.getEventValue("梅格耐斯普通全員獎勵") >= 1) { }
                        else {
                            player.addEventValue("梅格耐斯普通全員獎勵", 1, 1);
                            player.gainItem(4032053, 50);
                            player.gainItem(4001713, 30);
                            player.gainItem(4310058, 4);
