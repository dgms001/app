 ...
 * qq:381991414
 */
let MAP_ID = 105100300;
let EXIT_MAP = 867157500;
let mobId = 8830000; //增加
let bossHp = 2333333; //增加
var bossid = "巴洛谷[普通]";
...
let end;
let totalTime = 0;
let BOSS_LOG = "BossBalrog_NORMAL";
var bossname = "巴洛谷[普通]";
let DEATH_COUNT = 5;
var tupoTotal = 0;
let members;
function init(attachment) {
    ...
    map.spawnMob(mob, 416, 258);
    mob.changeBaseHp(bossHp);

    let mob2 = map.makeMob(8830004);
    mob2.setForcedMobStat(150, 1);
    map.spawnMob(mob2, 416, 258);
    mob2.changeBaseHp(bossHp);

    let mob3 = map.makeMob(8830002);
    mob3.setForcedMobStat(150, 1);
    map.spawnMob(mob3, 416, 258);
    mob3.changeBaseHp(bossHp);
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            player.gainItem(4032053, 5); //1-6名獎勵
            player.gainItem(4001713, 3)
            //player.gainItem(4000539, 0)
