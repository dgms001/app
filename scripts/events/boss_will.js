...
let start;
let totalTime = 0;
let bossHp = 10200000000000 + 15000000000000 + 30000000000000;
//let bossHp = 10000+10000+10000;
var bossid = "威爾[普通]";
let killPlayer = 0;
    ...
    switch (mob.getDataId()) {
        ...
        case 8880342:
            ...
            var itemList = [
                ...
                //2專屬
                Array(2, 1162080, 1000),
                Array(2, 1162081, 1000),
                Array(2, 1162082, 1000),
                Array(2, 1162083, 1000),

                Array(2, 2438412, 1000), //核心
                Array(2, 2438412, 1000), //核心
                Array(2, 2438412, 1000), //核心
                Array(2, 2438412, 1000), //核心
                Array(2, 2438412, 1000), //核心
...
function reward() {
    ...
    for (var i = 0; i < damList.length; i++) {
        ...
        //event.broadcastPlayerNotice(7, "[傷害排名] 排名:" + (i + 1) + "  玩家：" + player.getName() + "  傷害 ：" + damList[i][0] + "  傷害占比 : " + parseFloat(damList[i][0] / datotal) * 100 + " %");
		        player.addPQLog(practiceMode ? "PracticeMode" : BOSS_LOG)
        player.addEventValue(practiceMode ? "PracticeMode" : BOSS_LOG)
    }
