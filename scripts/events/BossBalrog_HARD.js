 ...
 * qq:381991414
 */
let MAP_ID = 105100400;
let EXIT_MAP = 867157500;
let mobId = 8830007; //增加
let bossHp = 200000000; //增加
var bossid = "巴洛谷[困難]";
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            //player.gainItem(4032053, 10); //1-6名獎勵
            //player.gainItem(4001713, 5);
