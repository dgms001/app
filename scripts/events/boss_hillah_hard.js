 ...
 * qq:381991414
 */
let MAP_ID = 262031300;
let EXIT_MAP = 262030000;
let mobId = 8870100; //增加
let bossHp = 40100000000; //增加
var bossid = "希拉[困難]";
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            /*
            if (player.getEventValue("希拉困難全員獎勵") >= 1) { }
            else {
                player.addEventValue("希拉困難全員獎勵", 1, 1);
