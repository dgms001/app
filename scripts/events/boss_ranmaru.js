 ...
 * qq:381991414
 */
let MAP_ID = 807300210;
let EXIT_MAP = 807300100;
let mobId = 9421581; //增加
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            player.addEventValue("森蘭丸普通難度", 1, 1);
            /*
            if (player.getEventValue("森蘭丸普通全員獎勵") >= 1) { }
            else {
                player.addEventValue("森蘭丸普通全員獎勵", 1, 1);
