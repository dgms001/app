...
let bossHp = 180000000000000 + 180000000000000 + 90000000000000;
var bossid = "露希妲[困難]";
let killPlayer = 0;
var tupoTotal = 0;
var bossname = "露希妲[困難]";
...
function mobHit(player, mob, damage) {
	var mobIds = [8880140, 8880150, 8880167]
