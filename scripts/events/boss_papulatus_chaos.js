...
let MAP_ID = 220080300;
let EXIT_MAP = 220080000;
let mobId = 8500021; //增加
let bossHp = 120000000000; //增加
var bossid = "拉圖斯[困難]";
...
let end;
let totalTime = 0;
let BOSS_LOG = "boss_papulatus_chaos";
var bossname = "拉圖斯[困難]";
let DEATH_COUNT = 5;
var tupoTotal = 0;
let members;
...
function init(attachment) {
    ...
    //mob.setForcedMobStat(150, 2); //數值5 連gm裝都打不到
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            /*
                        if (player.getEventValue("拉圖斯困難全員獎勵") >= 1) { }
                        else {
                            player.addEventValue("拉圖斯困難全員獎勵", 1, 1);
