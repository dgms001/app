 ...
 * qq:381991414
 */
let MAP_ID = 221030910;
let EXIT_MAP = 221030900;
let mobId = 9305699; //增加
let bossHp = 8400000000; //增加
var bossid = "卡翁[普通]";
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            if (player.getEventValue("卡翁普通全員獎勵") >= 1) { }
            else {
                player.addEventValue("卡翁普通全員獎勵", 1, 1);
