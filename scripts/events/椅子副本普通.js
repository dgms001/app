...
let mobList = Array(
	...
	//第1階段，蘑菇王
	Array(
		/*Array(9451080, 20000000000000, 1951, 440),
		Array(9451080, 20000000000000, 2484, 440),*/
		Array(9451080, 20000000000000, 3017, 440),
		Array(9451080, 20000000000000, 2750, 215),
		Array(9451080, 20000000000000, 2218, 215),
		Array(9451080, 20000000000000, 2750, -25),
		Array(9451080, 20000000000000, 2218, -25),

		Array(9601301, 10100000000000, 1851, 440),
		Array(9601301, 10100000000000, 2051, 440),
		Array(9601301, 10100000000000, 2251, 440),
		Array(9601301, 10100000000000, 2451, 440),
		Array(9601301, 10100000000000, 2651, 440),
		Array(9601301, 10100000000000, 2851, 440),
		Array(9601301, 10100000000000, 3051, 440),

		Array(9601301, 10100000000000, 1851, 215),
		Array(9601301, 10100000000000, 2051, 215),
		Array(9601301, 10100000000000, 2251, 215),
		Array(9601301, 10100000000000, 2451, 215),
		Array(9601301, 10100000000000, 2651, 215),
		Array(9601301, 10100000000000, 2851, 215),
		Array(9601301, 10100000000000, 3051, 215),

		Array(9601301, 10100000000000, 1851, -25),
		Array(9601301, 10100000000000, 2051, -25),
		Array(9601301, 10100000000000, 2251, -25),
		Array(9601301, 10100000000000, 2451, -25),
		Array(9601301, 10100000000000, 2651, -25),
		Array(9601301, 10100000000000, 2851, -25),
		Array(9601301, 10100000000000, 3051, -25),
	...
	Array(
		//怪物ID 血量 X坐標 Y坐標
		/*Array(9451060, 20000000000000, 1951, 440),
		Array(9451060, 20000000000000, 2484, 440),*/
		Array(9451060, 20000000000000, 3017, 440),
		Array(9451060, 20000000000000, 2750, 215),
		Array(9451060, 20000000000000, 2218, 215),
		Array(9451060, 20000000000000, 2750, -25),
		Array(9451060, 20000000000000, 2218, -25),
	...
	Array(
		//怪物ID 血量 X坐標 Y坐標
		Array(9451040, 40000000000000, 1951, 440),
		Array(9451040, 40000000000000, 2484, 440),
		Array(9451040, 40000000000000, 3017, 440),
		Array(9451040, 40000000000000, 2750, 215),
		Array(9451040, 40000000000000, 2218, 215),
	...
	Array(
		//怪物ID 血量 X坐標 Y坐標
		Array(9402196, 49990000, 2750, 215)
	),
	//第5階段，阿麗莎
	/*Array(
		//怪物ID 血量 X坐標 Y坐標
...
function init(attachment) {
	...
	for (let i = 0; i < members.length; i++) {
		if (members[i].getEventValue("椅子副本普通") >= 1) {
			members[i].showSystemMessage("今日普通副本進入次數已滿,強制離場.");
		...
		//members[i].showSystemMessage("你進入了普通副本");
	}
	...
	if (level >= mobList.length) { //當前關卡大於number 則通關
		if (event.getMap(MAP_ID).getEventMobCount() <= 0) {
			for (let i = 0; i < members.length; i++) {
				...
				members[i].showSystemMessage("恭喜玩家獲得領取椅子副本普通全員獎勵!!");
				members[i].addEventValue("椅子副本普通全員獎勵", 1, 1);
...
function startMobs() {
	...
	for (var i = 0; i < (moblevel / 100) * 3; i++) {//10*招喚數量
		var mob = map.makeMob(9402010);
		//mob.setForcedMobStat(260, 25);
