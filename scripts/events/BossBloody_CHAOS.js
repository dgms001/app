 ...
 * qq:381991414
 */
let MAP_ID = 105200711;
let EXIT_MAP = 105200000;
let mobId = 8920000; //增加
let bossHp = 350000000000; //增加
var bossid = "血腥女王[困難]";
...
let end;
let totalTime = 0;
let BOSS_LOG = "BossBloody_CHAOS";
var bossname = "血腥女王[困難]";
let DEATH_COUNT = 5;
var tupoTotal = 0;
let members;
...
function mobDied(mob) {
    if (mobId >= mob.getDataId()) {
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            /*
            if (player.getEventValue("血腥皇后困難全員獎勵") >= 1) { }
            else {
                player.addEventValue("血腥皇后困難全員獎勵", 1, 1);
