 ...
 * qq:381991414
 */
let MAP_ID = 105200811;
let EXIT_MAP = 105200000;
let mobId = 8930100; //增加
let bossHp = 400000000000; //增加
var bossid = "貝倫[困難]";
...
function init(attachment) {
    ...
    //mob.setForcedMobStat(200, 5);
    mob.changeBaseHp(bossHp);
    map.spawnMob(mob, -190, 443);
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        var itemList = [
            ...
            //3武防
            Array(3, 1232057, 6000),
            Array(3, 1312153, 6000),
            Array(3, 1322203, 6000),
            Array(3, 1302275, 6000),
            Array(3, 1402196, 6000),
            Array(3, 1412135, 6000),
            Array(3, 1422140, 6000),
            Array(3, 1432167, 6000),
            Array(3, 1442223, 6000),
            Array(3, 1582016, 6000),
            Array(3, 1542063, 6000),
            Array(3, 1213016, 6000),
            Array(3, 1212063, 6000),
            Array(3, 1262016, 6000),
            Array(3, 1372177, 6000),
            Array(3, 1382208, 6000),
            Array(3, 1252015, 6000),
            Array(3, 1552063, 6000),
            Array(3, 1282015, 6000),
            Array(3, 1452205, 6000),
            Array(3, 1462193, 6000),
            Array(3, 1522094, 6000),
            Array(3, 1592018, 6000),
            Array(3, 1214016, 6000),
            Array(3, 1242060, 6000),
            Array(3, 1332225, 6000),
            Array(3, 1342082, 6000),
            Array(3, 1362090, 6000),
            Array(3, 1472214, 6000),
            Array(3, 1292016, 6000),
            Array(3, 1272015, 6000),
            Array(3, 1222058, 6000),
            Array(3, 1242061, 6000),
            Array(3, 1482168, 6000),
            Array(3, 1492179, 6000),
            Array(3, 1532098, 6000),
            Array(3, 1403016, 6000),
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            /*
            if (player.getEventValue("貝倫困難全員獎勵") >= 1) { }
            else {
                player.addEventValue("貝倫困難全員獎勵", 1, 1);
                player.gainItem(4032053, 100);
                player.gainItem(4001713, 50);
                player.gainItem(4000540, 6);
                player.gainItem(2630512, 4);
