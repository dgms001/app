 ...
 * qq:381991414
 */
let MAP_ID = 105200611;
let EXIT_MAP = 105200000;
let mobId = 8900000; //增加
let bossHp = 250000000000; //增加
var bossid = "比艾樂[困難]";
...
let end;
let totalTime = 0;
let BOSS_LOG = "boss_pierre_chaos";
var bossname = "比艾樂[困難]";
let DEATH_COUNT = 5;
var tupoTotal = 0;
let members;
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            /*
            if (player.getEventValue("比艾樂困難全員獎勵") >= 1) { }
            else {
                player.addEventValue("比艾樂困難全員獎勵", 1, 1);
                player.gainItem(4032053, 50); //1-6名獎勵
                player.gainItem(4001713, 25);
                player.gainItem(4000540, 3);
