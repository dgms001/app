 ...
 * qq:381991414
 */
let MAP_ID = 262030300;
let EXIT_MAP = 262030000;
let mobId = 8870000; //增加
let bossHp = 10100000000; //增加
var bossid = "希拉[普通]";
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        var itemList = [
            ...
            //2專屬
            //Array(2,1112952,15000),
            //Array(2,1032136,15000),
            //Array(2,1162009,15000),
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            /*
            if (player.getEventValue("希拉普通全員獎勵") >= 1) { }
            else {
                player.addEventValue("希拉普通全員獎勵", 1, 1);
                player.gainItem(4032053, 30); //1-6名獎勵
        ...
        //vent.broadcastPlayerNotice(7, "[擊殺獎勵]通關時間: " + totalTime + " 秒 擊殺 玩家：" + damList[killId][1].getName() + "  傷害 ：" + damList[killId][0] + "  傷害占比 : " + parseFloat(damList[killId][0] / datotal) * 100 + " %");
    }
}
