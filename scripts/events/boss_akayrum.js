...
let MAP_ID = 272020210;
let EXIT_MAP = 272020110;
let mobId = 8860005; //增加
let bossHp = 40500000000; //增加
var bossid = "阿卡伊農[困難]";
...
let end;
let totalTime = 0;
let BOSS_LOG = "boss_akayrum";
var bossname = "阿卡伊農[困難]";
let DEATH_COUNT = 5;
var tupoTotal = 0;
let members;
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        var itemList = [
            ...
            //2專屬
            //Array(2,1122150,10000),
            //Array(2,2046374,20000),
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            /*
                        if (player.getEventValue("阿卡伊農困難全員獎勵") >= 1) { }
                        else {
                            player.addEventValue("阿卡伊農困難全員獎勵", 1, 1);
