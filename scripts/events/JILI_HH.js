...
function init(attachment) {
    ...
    for (let i = 0; i < members.length; i++) {
        if (members[i].getEventValue("航海爭略") >= 5) {
    ...
    switch (stage) {
        ...
        case 3:
            if (!"clear".equals(event.getVariable("stage" + stage))) {
                ...
                mob.changeBaseHp(103000000000);//1000E
        ...
        case 10:
            if (!"clear".equals(event.getVariable("stage" + stage))) {
                for (var i = 0; i < 20; i++) {
                    var mob = map_1.makeMob(9390824); /* 海螺姑娘 */
                    mob.changeBaseHp(10300000000);//100E
                    map_1.spawnMob(mob, 220 - i * 15, 199);
                }
                map_1.blowWeatherEffectNotice("它有著鋒利的趾甲·······你要小心不要受傷啊。", 133, 5000);
                stageClear(stage);
        ...
        case 11:
            if (!"clear".equals(event.getVariable("stage" + stage))) {
                ...
                mob.changeBaseHp(103000000000);//2000E
        ...
        case 18:
            if (!"clear".equals(event.getVariable("stage" + stage))) {
                ...
                mob.changeBaseHp(1030000000000);//10000E
                map_1.spawnMob(mob, 690, 454);
