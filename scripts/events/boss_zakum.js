 ...
 * qq:381991414
 */
let MAP_ID = 280030100;
let EXIT_MAP = 211042300;
let mobId = 8800002; //增加
let bossHp = 50000000000; //增加
var bossid = "炎魔[普通]";
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        var itemList = [
            ...
            //2專屬
            //Array(2,1022231,15000),
            //Array(2,1012478,15000),	
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            /*
            if (player.getEventValue("炎魔普通全員獎勵") >= 1) {
            } else {
                player.addEventValue("炎魔普通全員獎勵", 1, 1);
                player.gainItem(4032053, 20); //楓葉
                player.gainItem(4001713, 10); //定居金10W
            ...
            //event.broadcastPlayerNotice(5,"擊殺公告1");
