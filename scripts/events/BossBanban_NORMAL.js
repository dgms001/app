 ...
 * qq:381991414
 */
let MAP_ID = 105200111;
let EXIT_MAP = 105200000;
let mobId = 8910100; //增加
let bossHp = 60000000000; //增加
var bossid = "斑斑[普通]";
...
let end;
let totalTime = 0;
let BOSS_LOG = "BossBanban_NORMAL";
var bossname = "斑斑[普通]";
let DEATH_COUNT = 5;
var tupoTotal = 0;
let members;
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            /*
            if (player.getEventValue("斑斑普通全員獎勵") >= 1) { }
            else {
                player.addEventValue("斑斑普通全員獎勵", 1, 1);
