 ...
 * qq:381991414
 */
let MAP_ID = 280030000;
let EXIT_MAP = 211042300;
let mobId = 8800102; //增加
let bossHp = 150000000000; //增加
var bossid = "炎魔[困難]";
let party;
let killPlayer = 0;
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            /*
                        if (player.getEventValue("炎魔困難全員獎勵") >= 1) { }
                        else {
                            player.addEventValue("炎魔困難全員獎勵", 1, 1);
                            player.gainItem(4032053, 30); //獎勵
