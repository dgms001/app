 ...
 * qq:381991414
 */
let MAP_ID = 211070104;
let EXIT_MAP = 211070000;
let mobId = 8840014; //增加
let bossHp = 90000000000; //增加
var bossid = "凡雷恩[困難]";
...
let end;
let totalTime = 0;
let BOSS_LOG = "boss_vonleon_hard";
var bossname = "凡雷恩[困難]";
let DEATH_COUNT = 5;
var tupoTotal = 0;
let members;
function init(attachment) {
    ...
    //mob.setForcedMobStat(150, 10);
    map.spawnMob(mob, -5, -181);
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        var itemList = [
            ...
            //2專屬
            //Array(2,1112429,15000),
            //Array(2,1113089,15000),
            //Array(2,1032227,15000),
            //Array(2,1122274,15000),
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            /*
            if (player.getEventValue("凡雷恩困難全員獎勵") >= 1) { }
            else {
                player.addEventValue("凡雷恩困難全員獎勵", 1, 1);
                player.gainItem(4032053, 50); //1-6名獎勵
                player.gainItem(4001713, 20);
