 ...
 * qq:381991414
 */
let MAP_ID = 271041100;
let FIELD_2 = 271040300;
let EXIT_MAP = 271040000;
let mobId = 8850111; //增加
let bossHp = 52500000000; //增加
var bossid = "西格諾斯[普通]";
...
let end;
let totalTime = 0;
let BOSS_LOG = "boss_shinas";
var bossname = "西格諾斯[普通]";
let DEATH_COUNT = 5;
var tupoTotal = 0;
let members;
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            /*
            if (player.getEventValue("西格諾斯普通全員獎勵") >= 1) { }
            else {
                player.addEventValue("西格諾斯普通全員獎勵", 1, 1);
