...
function init(attachment) {
    ...
    // let dummy = map.makeMob(mobId);
    // dummy.setForcedMobStat(250,1000);
    // dummy.changeBaseHp(bossHp);
    // map.spawnMob(dummy, -5, -181);
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            /*if(player.getEventValue("凡雷恩創世全員獎勵")>=2){
            } else {
            player.addEventValue("凡雷恩創世全員獎勵",1,1);
