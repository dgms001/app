...
var BossId_2 = 9401065;//美杜莎9401065
var BossId_3 = 9401065;//美杜莎9401065
var Pos = Array(
	Array(2139, -451),
	Array(3495, -452),
	Array(2053, 29),
...
function init(attachment) {
	...
	event.startTimer("reSummonMob", 1000 * 3);
	map_1.showTimer(3);
	//map_1.reset();
	...
	for (let i = 0; i < members.length; i++) {
		if (members[i].getEventValue("次元入侵") > 0) {
...
function reSummonMob() {//祭壇
	...
	boss.changeBaseHp(10000000000 * HP1);//祭壇
...
function SpawnWave() {//小怪
	...
	for (var i = 0; i < 50; i++) {
		...
		boss.changeBaseHp(10000000000 * HP2);//小怪
	...
	if (map_1.getEventMobCount() == 0) {
		switch (parseInt(event.getVariable("state"))) {
			...
			case 30:
				...
				break;
			case 31://任務完成部分
				event.startTimer("jiangli", 1000 * 8);
				break;
		}
	}
...
function jiangli() {
	var players = event.getMap(FIELD_1).getPlayers()
