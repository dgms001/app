 ...
 * qq:381991414
 */
let MAP_ID = 105200511;
let EXIT_MAP = 105200000;
let mobId = 8910000; //增加
let bossHp = 300000000000; //增加
var bossid = "斑斑[困難]";
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            /*
            if (player.getEventValue("斑斑困難全員獎勵") >= 1) { }
            else {
                player.addEventValue("斑斑困難全員獎勵", 1, 1);
