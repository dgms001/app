...
let MAP_ID = 272020200;
let EXIT_MAP = 272020110;
let mobId = 8860000; //增加
let bossHp = 10500000000; //增加
var bossid = "阿卡伊農[普通]";
...
let end;
let totalTime = 0;
let BOSS_LOG = "boss_akayrum_easy";
var bossname = "阿卡伊農[普通]";
let DEATH_COUNT = 5;
var tupoTotal = 0;
let members;
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        var itemList = [
            ...
            //2專屬
            //Array(2,1122150,8000),
            //Array(2,2046374,15000),
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            /*
                        if (player.getEventValue("阿卡伊農普通全員獎勵") >= 1) { }
                        else {
                            player.addEventValue("阿卡伊農普通全員獎勵", 1, 1);
