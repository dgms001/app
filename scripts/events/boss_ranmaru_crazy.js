 ...
 * qq:381991414
 */
let MAP_ID = 807300110;
let EXIT_MAP = 807300100;
let mobId = 9421589; //增加
let bossHp = 450000000000; //增加
var bossid = "森蘭丸[困難]";
...
let end;
let totalTime = 0;
let BOSS_LOG = "boss_ranmaru_crazy";
var bossname = "森蘭丸[困難]";
let DEATH_COUNT = 5;
var tupoTotal = 0;
let members;
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            /*
            if (player.getEventValue("森蘭丸困難全員獎勵") >= 1) { }
            else {
                player.addEventValue("森蘭丸困難全員獎勵", 1, 1);
