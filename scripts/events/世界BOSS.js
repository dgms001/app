...
var event = npc.getEvent("testboss")
...
sss += "#k8.角色挑戰等級：" + level + "  "//成功挑戰將獲得家族積分+1000\r\n
            ...
            if (todrop == null) {
                ...
                if (false) {
                    ...
                    if (week == 0 || week == 1 || week == 3 || week == 5 || week == 6) { //只有1+3+5+7
                        ...
                        let event = npc.getEvent("testboss");
                        if (event == null) {
                            if (player.getFreeSlots(1) < 4 || player.getFreeSlots(2) < 4 || player.getFreeSlots(3) < 4 || player.getFreeSlots(4) < 2 || player.getFreeSlots(5) < 4) {
                                ...
                                //makeEvent
                                event = npc.makeEvent("testboss", true, [guildId, player, guildName]);
                                if (event == null) {
