...
let mobList = Array(
	Array(
		Array(9450014, HPS * 1.5, 75, 0)
	),
	Array(
		Array(9450020, HPS * 2, 75, 0)
	),
	Array(
		Array(9450014, HPS * 2.5, 75, 0)
	),
	Array(
		Array(9450020, HPS * 3, 75, 0)
	),
	Array(
		Array(9450014, HPS * 3.5, 25, 0)
	),
	Array(
		Array(9450020, HPS * 4, 25, 0)
	),
	Array(
		Array(9450014, HPS * 4.5, 25, 0)
	),
	Array(
		Array(9450020, HPS * 5, 75, 0)
	),
	Array(
		Array(9450014, HPS * 5.5, 75, 0)
	),
	Array(
		Array(9450038, HPS * 6, 0, 0)
	)
);
...
let MAP_ID = 811000007;//0~1000 , 210
let BOSS_LOG = "戰國無雙";
let level = 0;
let mustLevel = 1;
let totalTime = 0;
...
function init(attachment) {
	...
	for (let i = 0; i < members.length; i++) {
		if (members[i].getEventValue("戰國無雙") >= 30) {
