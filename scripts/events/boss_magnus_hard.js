 ...
 * qq:381991414
 */
let MAP_ID = 401060200;
let EXIT_MAP = 401060000;
let mobId = 8880000; //增加
let bossHp = 1010000000000; //增加
var bossid = "梅格耐斯[困難]";
...
let end;
let totalTime = 0;
let BOSS_LOG = "boss_magnus_hard";
var bossname = "梅格耐斯[困難]";
let DEATH_COUNT = 5;
var tupoTotal = 0;
let members;
...
function mobDied(mob) {
    if (mobId == mob.getDataId()) {
        ...
        var itemList = [
            //1卷軸
            Array(1, 2048815, 45000, 30000),
            Array(1, 2048816, 45000, 30000),
            Array(1, 2612055, 45000, 30000),
            Array(1, 2612056, 45000, 30000),
            Array(1, 2613048, 45000, 30000),
            Array(1, 2613049, 45000, 30000),
            Array(1, 2615029, 45000, 30000),
            Array(1, 2615030, 45000, 30000),
            Array(1, 2616059, 45000, 30000),
            Array(1, 2616060, 45000, 30000),
            //2專屬
            //Array(2,1112951,6000),
            //Array(2,1182087,6000),
            //Array(2,1152170,6000),

            //3武防
            Array(3, 1102481, 1000),
            Array(3, 1102482, 1000),
            Array(3, 1102483, 1000),
            Array(3, 1102484, 1000),
            Array(3, 1102485, 1000),
            Array(3, 1082543, 1000),
            Array(3, 1082544, 1000),
            Array(3, 1082545, 1000),
            Array(3, 1082546, 1000),
            Array(3, 1082547, 1000),
            Array(3, 1072743, 1000),
            Array(3, 1072744, 1000),
            Array(3, 1072745, 1000),
            Array(3, 1072746, 1000),
            Array(3, 1072747, 1000),
        ...
        for (var i = 0; i < damList.length; i++) {
            ...
            /*
            if (player.getEventValue("梅格耐斯困難全員獎勵") >= 1) { }
            else {
                player.addEventValue("梅格耐斯困難全員獎勵", 1, 1);
                player.gainItem(4032053, 100);
                player.gainItem(4001713, 50);
                player.gainItem(4310058, 6);
