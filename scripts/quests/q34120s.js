...
npc.sayNextS("#b（拾取了卡奧離開時留下的神祕徽章：消亡旅途。）");
if (player.getFreeSlots(1) > 0) {
    ...
    //npc.broadcastGachaponMsgEx("[任務公告] 恭喜 " + player.getName() + " 完成了劇情任務-【神祕河-消亡旅途】開啟拍賣選單-特色功能-劇情任務-即可領取貝勒德幣、超越證明戒指、世界樹符文石、10億金幣" + newItem.getItemName(), newItem);
} else {
    npc.sayNext("請保證裝備欄有足夠的空格。");
}