...
npc.sayNextENoEsc("#b艾咪！", true);
npc.sayNextENoEsc("#face2##h0#~你是來表示感謝的吧？呼，你能有這種房屋都是因為我艾咪哦！你可不能忘記這件事。", 9400920);
npc.sayNextENoEsc("#b沒錯，謝謝你讓我來到了這裡。", true);
let sel = npc.askMenuENoEsc("#b所以說……我覺得如果以後裝修房屋的事情也能和艾咪一起完成，那就太好了。\r\n#b#L0# 請你成為我的管理人。#l\r\n#L1#今後我們一起好好相處吧。#l\r\n#r(※只能雇傭1名管理人，雇傭後可以通過管理人菜單進行變更。)#l", true);
if (sel == 0) {
        npc.sayNextENoEsc("#face1#管理人？管理人？嗯……聽起來倒是很有趣，你會給我報酬的吧？ ", 9400920);
        npc.sayNextENoEsc("#face2#這樣啊，好的！那我就答應你吧，#h0#。", 9400920);
        npc.sayNextENoEsc("#face1#對了，這是給#h0#的禮物！因為你說想要用高級的家裝飾，我就準備了這個。它還有很厲害的功能，你可別被嚇到了哦！ ", 9400920);
        ...
        npc.sayNextENoEsc("#face2##h0#嗯！肯定會好好相處的啦。", 9400920);
}
